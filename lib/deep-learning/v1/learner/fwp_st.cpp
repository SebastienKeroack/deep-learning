                                                     ...
                                                     long long int output_layer_index_received)
{
    ...
    if (input_layer_index_received >= output_layer_index_received) {
      ERR(L"Input layer index (%lld) can not be "
          L"greater or equal to the output layer index(%lld).",
          input_layer_index_received, output_layer_index_received);
      return;
    }
                                                                                                                ...
                                                                                                                var *const ptr_array_output_normalizes_received)
{
    ...
    for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index)
    {
        ...
        ptr_array_variances_received[tmp_input_timed_index + tmp_input_index] = op_sqrt(ptr_array_variances_received[tmp_input_timed_index + tmp_input_index] * tmp_batch_scale - ptr_array_means_received[tmp_input_timed_index + tmp_input_index] * ptr_array_means_received[tmp_input_timed_index + tmp_input_index] + tmp_epsilon);
                                                                                                                   ...
                                                                                                                   var *const ptr_array_output_normalizes_received)
{
    ...
    for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index)
    {
        ...
        ptr_array_r_corrections_received[tmp_input_timed_index + tmp_input_index] = clip<var>(tmp_gamma, tmp_r_correction, tmp_r_correction_maximum);
        ...
        ptr_array_d_corrections_received[tmp_input_timed_index + tmp_input_index] = clip<var>(tmp_d_correction, -tmp_d_correction_maximum, tmp_d_correction_maximum);
    }
