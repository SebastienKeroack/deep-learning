...
{ ptr_cuModel_received->set_weight_decay(regularization__weight_decay_received); }

__host__ __device__ bool cuModel::set_weight_decay(var const regularization__weight_decay_received)
{
#ifndef __CUDA_ARCH__
