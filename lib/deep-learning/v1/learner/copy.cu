                                                                                                   ...
                                                                                                   class cuModel *const ptr_cuModel_received)
{
    ...
    *ptr_cuModel_received->ptr_array_accuracy_values[4] = ptr_array_accuracy_value_received[4];
    ...
    ptr_cuModel_received->set_l1(model->regularization__l1);
    ptr_cuModel_received->set_l2(model->regularization__l2);
    ptr_cuModel_received->set_weight_decay(model->weight_decay);
