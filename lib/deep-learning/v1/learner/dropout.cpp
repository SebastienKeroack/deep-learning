...
bool Model::set_dropout(size_t const index_layer_received,
  ...
  return (this->set_dropout(this->ptr_array_layers + index_layer_received,
                            type_layer_dropout_received, value_dropout_received,
...
bool Model::set_dropout(Layer *const ptr_layer_received,
  ...
  switch (type_layer_dropout_received) {
    case LAYER_DROPOUT::NONE:
      return (this->Set__Dropout_None(ptr_layer_received));
    case LAYER_DROPOUT::ALPHA:
      return (this->Set__Dropout_Alpha(ptr_layer_received,
    ...
    case LAYER_DROPOUT::BERNOULLI_INVERTED:
      return (this->Set__Dropout_Bernoulli_Inverted(ptr_layer_received,
                                                    value_dropout_received[0]));
    case LAYER_DROPOUT::GAUSSIAN:
      return (this->Set__Dropout_Gaussian(ptr_layer_received,
                                          value_dropout_received[0]));
    case LAYER_DROPOUT::SHAKEDROP:
      return (this->Set__Dropout_ShakeDrop(ptr_layer_received,
                                           value_dropout_received[0]));
    case LAYER_DROPOUT::UOUT:
      return (this->Set__Dropout_Uout(ptr_layer_received,
                                      value_dropout_received[0]));
...
bool Model::Set__Dropout_None(Layer *const ptr_layer_received) {
  switch (ptr_layer_received->type_dropout) {
    case LAYER_DROPOUT::NONE:
      return true;
    case LAYER_DROPOUT::ALPHA:
      return (this->Set__Dropout_Alpha(ptr_layer_received, 0_r));
    case LAYER_DROPOUT::BERNOULLI:
      return (this->Set__Dropout_Bernoulli(ptr_layer_received, 1_r));
    case LAYER_DROPOUT::BERNOULLI_INVERTED:
      return (this->Set__Dropout_Bernoulli_Inverted(ptr_layer_received, 1_r));
    case LAYER_DROPOUT::GAUSSIAN:
      return (this->Set__Dropout_Gaussian(ptr_layer_received, 0_r));
    case LAYER_DROPOUT::SHAKEDROP:
      return (this->Set__Dropout_ShakeDrop(ptr_layer_received, 0_r));
    case LAYER_DROPOUT::UOUT:
      return (this->Set__Dropout_Uout(ptr_layer_received, 0_r));
    case LAYER_DROPOUT::ZONEOUT:
      return (this->Set__Dropout_Zoneout(ptr_layer_received, 0_r, 0_r));
    default:
...
bool Model::Set__Dropout_Alpha(Layer *const ptr_layer_received,
  ...
  if (ptr_layer_received->type_dropout != LAYER_DROPOUT::ALPHA ||
    ...
    if (ptr_layer_received->type_dropout != LAYER_DROPOUT::ALPHA) {
      if (this->Set__Dropout_None(ptr_layer_received) == false) {
        ERR(L"An error has been triggered from the "
            L"`Set__Dropout_None(ptr)` function.");
        return false;
      }
    }
    ...
    if (dropout_probability_received != 0_r &&
        ptr_layer_received->type_dropout == LAYER_DROPOUT::NONE) {
      ptr_layer_received->type_dropout = LAYER_DROPOUT::ALPHA;

      constexpr real alpha(-SELU_Scale * SELU_Alpha);

      ptr_layer_received->dropout_values[1] = std::pow(
          tmp_keep_probability + std::pow(alpha, 2_r) * tmp_keep_probability *
                                     dropout_probability_received,
          -0.5_r);
      ptr_layer_received->dropout_values[2] =
          -ptr_layer_received->dropout_values[1] *
          dropout_probability_received * alpha;

      if (++this->total_dropout_alpha_layers == 1_UZ) {
        if (this->Allocate__Generator__Dropout_Bernoulli() == false) {
          ERR(L"An error has been triggered from the "
              L"`Allocate__Generator__Dropout_Bernoulli()` function.");
          ...
          ERR(L"An error has been triggered from the "
              L"`Allocate__Neuron__Mask_Dropout_Bernoulli()` function.");
...
bool Model::Set__Dropout_Bernoulli(Layer *const ptr_layer_received,
  ...
  if (ptr_layer_received->type_dropout != LAYER_DROPOUT::BERNOULLI ||
    ...
    if (scale_weights_received &&
        ...
        ptr_layer_received->dropout_values[0] !=
            retention_probability_received) {
      this->Scale_Weight__Dropout(ptr_layer_received->dropout_values[0] /
                                      retention_probability_received,
                                  ptr_layer_received);
    }
    ...
    if (retention_probability_received != 1_r &&
        ptr_layer_received->type_dropout == LAYER_DROPOUT::NONE) {
...
bool Model::Set__Dropout_Bernoulli_Inverted(
...
bool Model::Set__Dropout_Gaussian(Layer *const ptr_layer_received,
                                  real const dropout_probability_received) {
  if (ptr_layer_received == nullptr) {
    ERR(L"`ptr_layer_received` is a nullptr.");
    return false;
  ...
  if (ptr_layer_received->type_dropout != LAYER_DROPOUT::GAUSSIAN ||
    ...
    // ptr_layer_received->dropout_values[0] = dropout_probability_received ==
    // 1_r ? 0_r :
    // static_cast<real>(pow(sqrt(static_cast<double>(dropout_probability_received)
    // / (1.0 - static_cast<double>(dropout_probability_received))), 2.0));
    ptr_layer_received->dropout_values[0] =
        dropout_probability_received == 1_r
            ? 0_r
            : static_cast<real>(
                  static_cast<double>(dropout_probability_received) /
                  (1.0 - static_cast<double>(dropout_probability_received)));
    ...
    if (dropout_probability_received != 0_r &&
      ...
      if (++this->total_dropout_gaussian_layers == 1_UZ) {
        if (this->Allocate__Generator__Dropout_Gaussian() == false) {
          ERR(L"An error has been triggered from the "
              L"`Allocate__Generator__Dropout_Gaussian()` function.");
      ...
      if (this->total_dropout_gaussian_layers != 0_UZ &&
          --this->total_dropout_gaussian_layers == 0_UZ) {
...
bool Model::Set__Dropout_ShakeDrop(Layer *const ptr_layer_received,
                                   real const dropout_probability_received) {
  if (ptr_layer_received == nullptr) {
    ERR(L"`ptr_layer_received` is a nullptr.");
    return false;
  ...
  if (ptr_layer_received->type_dropout != LAYER_DROPOUT::SHAKEDROP ||
    ...
    // The paper recommends linear decay rule to determine pl (pl = layer
    // dropout probability, pL = initial dropout probability). l = block index,
    // L = total block. pl = 1 - ( (l / L * (1 - pL) )
    ptr_layer_received->dropout_values[0] = dropout_probability_received;
    ...
    if (dropout_probability_received != 0_r &&
      ...
      if (++this->total_dropout_shakedrop_layers == 1_UZ) {
        if (this->Allocate__Generator__Dropout_ShakeDrop() == false) {
          ERR(L"An error has been triggered from the "
              L"`Allocate__Generator__Dropout_ShakeDrop()` function.");
          ...
          ERR(L"An error has been triggered from the "
              L"`Allocate__Layer__Mask__Dropout__ShakeDrop()` function.");
      ...
      if (this->total_dropout_shakedrop_layers != 0_UZ &&
          --this->total_dropout_shakedrop_layers == 0_UZ) {
...
bool Model::Set__Dropout_Uout(Layer *const ptr_layer_received,
                              real const dropout_probability_received) {
  if (ptr_layer_received == nullptr) {
    ERR(L"`ptr_layer_received` is a nullptr.");
    return false;
    ...
    if (dropout_probability_received != 0_r &&
      ...
      if (++this->total_dropout_uout_layers == 1_UZ) {
        if (this->Allocate__Generator__Dropout_Uout() == false) {
          ERR(L"An error has been triggered from the "
              L"`Allocate__Generator__Dropout_Uout()` function.");
      ...
      if (this->total_dropout_uout_layers != 0_UZ &&
          --this->total_dropout_uout_layers == 0_UZ) {
...
bool Model::Set__Dropout_Zoneout(Layer *const ptr_layer_received,
  ...
  if (ptr_layer_received->type_dropout != LAYER_DROPOUT::ZONEOUT ||
    ...
    if (ptr_layer_received->type_dropout == LAYER_DROPOUT::NONE &&
        (zoneout_cell_received != 0_r || zoneout_hidden_received != 0_r)) {
      ...
      if (++this->total_dropout_zoneout_layers == 1_UZ) {
        if (this->Allocate__Generator__Dropout_Zoneout() == false) {
          ERR(L"An error has been triggered from the "
              L"`Allocate__Generator__Dropout_Zoneout()` function.");
          ...
          return false;
        } else if (this->Allocate__Block_Unit__Mask_Dropout_Zoneout() ==
                   false) {
          ERR(L"An error has been triggered from the "
              L"`Allocate__Block_Unit__Mask_Dropout_Zoneout()` function.");
    ...
    } else if (zoneout_cell_received == 0_r && zoneout_hidden_received == 0_r &&
               ptr_layer_received->type_dropout == LAYER_DROPOUT::ZONEOUT) {
      ptr_layer_received->type_dropout = LAYER_DROPOUT::NONE;

      if (this->total_dropout_zoneout_layers != 0_UZ &&
          --this->total_dropout_zoneout_layers == 0_UZ) {
...
void Model::Scale_Weight__Dropout(real const scale_factor_received,
  ...
  switch (layer_it->type_layer) {
    ...
    case LAYER::FULLY_CONNECTED_RECURRENT:
      this->Scale_Weight__FC__Recurrent__Dropout(scale_factor_received,
                                                 layer_it);
    case LAYER::FULLY_CONNECTED:
      this->Scale_Weight__FC__Forward__Dropout(scale_factor_received, layer_it);
      break;
    default:
...
void Model::Scale_Weight__FC__Forward__Dropout(real const scale_factor_received,
                                               Layer const *const layer_it) {
  Neuron_unit const *const tmp_ptr_layer_ptr_last_neuron_unit(
      layer_it->ptr_last_neuron_unit - 1),  // Get last neuron unit.
      *const tmp_ptr_layer_ptr_first_neuron_unit(
          layer_it->ptr_array_neuron_units);

  var const *const tmp_ptr_array_parameters_end(
      this->ptr_array_parameters +
      *tmp_ptr_layer_ptr_last_neuron_unit->ptr_last_connection_index);
  var *tmp_ptr_array_parameters_it(
      this->ptr_array_parameters +
      *tmp_ptr_layer_ptr_first_neuron_unit->ptr_first_connection_index);

  for (; tmp_ptr_array_parameters_it != tmp_ptr_array_parameters_end;
       ++tmp_ptr_array_parameters_it) {
    *tmp_ptr_array_parameters_it *= scale_factor_received;
  }
}

void Model::Scale_Weight__FC__Recurrent__Dropout(
    real const scale_factor_received, Layer const *const layer_it) {
  AF_Ind_recurrent_unit const *const tmp_ptr_layer_first_AF_Ind_recurrent_unit(
      layer_it->ptr_array_AF_Ind_recurrent_units);

  size_t const tmp_number_units(
      static_cast<size_t>(layer_it->ptr_last_AF_Ind_recurrent_unit -
                          tmp_ptr_layer_first_AF_Ind_recurrent_unit));

  var *tmp_ptr_array_parameters_it(this->ptr_array_parameters +
                                   *tmp_ptr_layer_first_AF_Ind_recurrent_unit
                                        ->ptr_recurrent_connection_index);
  var const *const tmp_ptr_array_parameters_end(tmp_ptr_array_parameters_it +
                                                tmp_number_units);
