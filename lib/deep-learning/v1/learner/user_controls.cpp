  ...
  if (this->Usable_Warm_Restarts()) {
      ...
      switch (parse_discrete(0, 3, L"Option: ")) {
          ...
          switch (this->type_optimizer_function) {
            case OPTIMIZER::GD:
              if (this->User_Controls__Optimizer__Gradient_Descent() == false) {
                ERR(
                    L"An error has been triggered from the "
                    L"`User_Controls__Optimizer__Gradient_Descent()` "
                    L"function.");
            ...
            case OPTIMIZER::IRPROP_PLUS:
              if (this->User_Controls__Optimizer__iRPROP() == false) {
                ERR(L"An error has been triggered from the "
                    L"`User_Controls__Optimizer__iRPROP()` function.");
            ...
            case OPTIMIZER::AMSGRAD:
              if (this->User_Controls__Optimizer__Adam() == false) {
                ERR(L"An error has been triggered from the "
                    L"`User_Controls__Optimizer__Adam()` function.");
            ...
            case OPTIMIZER::NOSADAM:
              if (this->User_Controls__Optimizer__NosAdam() == false) {
                ERR(L"An error has been triggered from the "
                    L"`User_Controls__Optimizer__NosAdam()` function.");
            ...
            case OPTIMIZER::AMSBOUND:
              if (this->User_Controls__Optimizer__AdaBound() == false) {
                ERR(L"An error has been triggered from the "
                    L"`User_Controls__Optimizer__AdaBound()` function.");
        ...
        case 1:
          if (this->User_Controls__Warm_Restarts() == false) {
            ERR(L"An error has been triggered from the "
                L"`User_Controls__Warm_Restarts()` function.");
        ...
        case 2:
          if (this->User_Controls__Optimizer_Function_Initializer() == false) {
            ERR(L"An error has been triggered from the "
                L"`User_Controls__Optimizer_Function_Initializer()` function.");
        ...
        default:
          ERR(L"An error has been triggered from the "
              L"`parse_discrete(%d, %d)` function.", 0, 3);
          break;
      }
    }
  } else {
    while (true) {
      ...
      switch (parse_discrete(0, 2, L"Option: ")) {
        ...
        default:
          ERR(L"An error has been triggered from the "
              L"`parse_discrete(%d, %d)` function.", 0, 2);
          break;
      }
    }
  }
...
bool Model::User_Controls__Optimizer__Gradient_Descent(void) {
  ...
  while (true) {
    ...
    INFO(L"[2]: Use Nesterov (%ls).", to_wstring(this->use_nesterov).c_str());
    INFO(L"[3]: Quit.");
...
bool Model::User_Controls__Optimizer__iRPROP(void) {
  ...
  while (true) {
    ...
    switch (parse_discrete(0, 5, L"Option: ")) {
      ...
      default:
        ERR(L"An error has been triggered from the "
            L"`parse_discrete(%d, %d)` function.", 0, 5);
        break;
    }
  }
...
bool Model::User_Controls__Optimizer__AdaBound(void) {
  ...
  while (true) {
    ...
    INFO(L"[5]: Bias correction (%ls).",
           to_wstring(this->use_adam_bias_correction).c_str());
    INFO(L"[6]: Modify gamma (%.9f).", this->learning_gamma);
    INFO(L"[7]: Quit.");

    switch (parse_discrete(0, 7, L"Option: ")) {
      case 0:
        INFO(L"");
        INFO(L"Learning rate.");
        INFO(L"Range[0.0, inf].");
      ...
      default:
        ERR(L"An error has been triggered from the "
            L"`parse_discrete(%d, %d)` function.", 0, 7);
        break;
    }
  }
...
bool Model::User_Controls__Optimizer__NosAdam(void) {
  ...
  while (true) {
    ...
    switch (parse_discrete(0, 6, L"Option: ")) {
      case 0:
        INFO(L"");
        INFO(L"Learning rate.");
        INFO(L"Range[0.0, inf].");
      ...
      default:
        ERR(L"An error has been triggered from the "
            L"`parse_discrete(%d, %d)` function.", 0, 6);
        break;
    }
  }
...
bool Model::User_Controls__Warm_Restarts(void) {
  ...
  while (true) {
    ...
    INFO(L"[0]: Use warm restarts (%ls).",
           to_wstring(this->use_warm_restarts).c_str());
    ...
    switch (parse_discrete(0, 6, L"Option: ")) {
      ...
      case 4:
        ...
        this->warm_restarts_initial_T_i =
            static_cast<real>(parse_discrete(
                0_UZ, L"Initial Ti: "));
...
bool Model::User_Controls__Accuracy_Variance(void) {
  ...
  if (this->Set__Accurancy_Variance(parse_real(
      ...
      false) {
    ERR(L"An error has been triggered from the "
        L"`Set__Accurancy_Variance()` function.");
...
bool Model::User_Controls__Time_Delays(void) {
  ...
  INFO(L"Range[0, %zu].",
         this->seq_w - 1_UZ);
  if (this->set_seq_w(parse_discrete(
          0_UZ, this->seq_w - 1_UZ, L"Time delays: ")) == false) {
    ERR(L"An error has been triggered from the "
        L"`set_seq_w()` function.");
...
bool Model::User_Controls__Max_Norm_Constaints(void) {
  ...
  if (this->Set__Regularization__Max_Norm_Constraints(
      ...
      false) {
    ERR(L"An error has been triggered from the "
        L"`Set__Regularization__Max_Norm_Constraints()` function.");
...
bool Model::User_Controls__Maximum__Batch_Size(void) {
  ...
  INFO(L"Range[1, inf].");
  INFO(L"default=8192.");
  if (this->set_max_batch_size(parse_discrete(
          1_UZ, L"Maximum batch size: ")) ==
      false) {
    ERR(L"An error has been triggered from the "
        L"`set_max_batch_size()` function.");
...
bool Model::User_Controls__OpenMP(void) {
  while (true) {
    ...
    INFO(L"[0]: Use OpenMP (%ls | %ls).", to_wstring(this->use_mp).c_str(),
           to_wstring(this->is_mp_initialized).c_str());
...
bool Model::User_Controls__Regularization(void) {
  while (true) {
    ...
    switch (parse_discrete(0, 9, L"Option: ")) {
      case 0:
        if (this->User_Controls__Max_Norm_Constaints() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Max_Norm_Constaints()` function.");
      ...
      case 1:
        if (this->User_Controls__L1_Regularization() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__L1_Regularization()` function.");
      ...
      case 2:
        if (this->User_Controls__L2_Regularization() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__L2_Regularization()` function.");
      ...
      case 3:
        if (this->User_Controls__SRIP_Regularization() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__SRIP_Regularization()` function.");
      ...
      case 4:
        ...
        INFO(L"Range[0.0, 1.0]. Off = 0.");
        INFO(L"default=1e-5.");
        if (this->set_weight_decay(
                parse_real(0_r, 1_r, L"Weight decay: ")) ==
            false) {
          ERR(L"An error has been triggered from the "
              L"`set_weight_decay()` function.");
      ...
      case 5:
        if (this->User_Controls__Dropout() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Dropout()` function.");
      ...
      case 6:
        if (this->User_Controls__Normalization() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Normalization()` function.");
      ...
      case 7:
        if (this->User_Controls__Tied__Parameter() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Tied__Parameter()` function.");
      ...
      case 8:
        if (this->User_Controls__K_Sparse() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__K_Sparse()` function.");
      ...
      default:
        ERR(L"An error has been triggered from the "
            L"`parse_discrete(%d, %d)` function.", 0, 9);
        break;
    }
  }
    ...
    if (tmp_option < static_cast<long long int>(tmp_option_end)) {
      ...
      switch ((tmp_type_layer_dropout = static_cast<LAYER_DROPOUT::TYPE>(
        ...
        case LAYER_DROPOUT::ZONEOUT:
          ...
          break;
        default:
          ERR(L"Type dropout layer (%d | %ls) is not managed in the switch.",
      ...
      if (tmp_option != -1ll) {
        if (this->set_dropout(layer_it, tmp_type_layer_dropout,
          ...
          ERR(L"An error has been triggered from the "
              L"`set_dropout(ptr, %d, %f, %f)` function.",
              ...
              if (layer_it->type_layer == LAYER::RESIDUAL) {
                if (this->set_dropout(
                        ...
                        std::array<real, 1_UZ>{
                            ...
                            .data()) == false) {
                  ERR(L"An error has been triggered from the "
                      L"`set_dropout(ptr, %d, %f)` function.",
                      tmp_type_layer_dropout,
      ...
      ERR(L"An error has been triggered from the "
          L"`parse_discrete<long long int>(%lld, %zu)` function.", -1ll, tmp_option_end);
    }
  }
...
bool Model::User_Controls__Normalization(void) {
  while (true) {
    ...
    INFO(L"[4]: Modify normalization (%ls).",
           to_wstring(this->Use__Normalization()).c_str());
    INFO(L"[5]: Quit.");
    ...
    switch (parse_discrete(0, 5, L"Option: ")) {
      case 0:
        ...
        if (this->Set__Normalization_Momentum_Average(
                parse_real(0_r, 1_r, L"Momentum average: ")) == false) {
          ERR(L"An error has been triggered from the "
              L"`Set__Normalization_Momentum_Average()` function.");
      ...
      case 1:
        ...
        if (this->Set__Normalization_Epsilon(parse_real(
                0_r, L"Epsilon: ")) == false) {
          ERR(L"An error has been triggered from the "
              L"`Set__Normalization_Epsilon()` function.");
      ...
      case 2:
        ...
        if (this->Set__Batch_Renormalization_r_Correction_Maximum(
                parse_real(0_r, L"r correction maximum: ")) == false) {
          ERR(
              L"An error has been triggered from the "
              L"`Set__Batch_Renormalization_r_Correction_Maximum()` function.");
      ...
      case 3:
        ...
        if (this->Set__Batch_Renormalization_d_Correction_Maximum(
                parse_real(0_r, L"d correction maximum: ")) == false) {
          ERR(
              L"An error has been triggered from the "
              L"`Set__Batch_Renormalization_d_Correction_Maximum()` function.");
      ...
      case 4:
        if (this->User_Controls__Normalization_Layer() == false) {
          ERR(
              L"An error has been triggered from the "
              L"`User_Controls__Normalization_Layer()` function.");
...
bool Model::User_Controls__Normalization_Layer(void) {
  ...
  while (true) {
    ...
    tmp_option = parse_discrete(0_UZ, tmp_option_end - 1_UZ, L"Option: ") +
                 1_UZ;
    ...
    if (tmp_option < tmp_option_end) {
      ...
      if (this->Set__Layer_Normalization(
              ...
              static_cast<LAYER_NORM::TYPE>(parse_discrete(
                  ...
                  (L"Hidden layer " +
                      ...
                      L", type: ").c_str()))) == false) {
        ERR(L"An error has been triggered from the "
            L"`Set__Layer_Normalization()` function.");
      ...
      ERR(L"An error has been triggered from the "
          L"`parse_discrete(%zu, %zu)` function.", 0_UZ,
          tmp_option_end - 1_UZ);
    }
  }
...
bool Model::User_Controls__Tied__Parameter(void) {
  ...
  while (true) {
    ...
    if (tmp_option < tmp_option_end) {
      ...
      INFO(L"default=%ls.",
             to_wstring(this->type == MODEL::AUTOENCODER).c_str());
      if (this->Set__Tied_Parameter(
              layer_it,
              layer_it->Use__Tied_Parameter() == false) == false) {
        ERR(
            L"An error has been triggered from the "
            L"`Set__Alpha_Sparsity(ptr)` function.");
  ...
  while (true) {
    ...
    if (tmp_option < tmp_option_end) {
      ...
      if (this->Set__K_Sparsity(
          ...
          false) {
        ERR(L"An error has been triggered from the "
            L"`Set__K_Sparsity(ptr)` function.");
...
bool Model::user_controls(void) {
  while (true) {
    ...
    INFO(L"[6]: clip gradient (%ls).",
           to_wstring(this->Use__Clip_Gradient()).c_str());
    ...
    switch (parse_discrete(0, 13, L"Option: ")) {
      case 0:
      ...
      case 2:
        if (this->User_Controls__Weights_Initializer() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Weights_Initializer()` function.");
      ...
      case 3:
        if (this->User_Controls__Optimizer_Function() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Optimizer_Function()` function.");
      ...
      case 4:
        if (this->User_Controls__Loss_Function_Initializer() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Loss_Function_Initializer()` function.");
      ...
      case 5:
        if (this->User_Controls__Accuracy_Function_Initializer() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Accuracy_Function_Initializer()` function.");
      ...
      case 6:
        if (this->User_Controls__Clip_Gradient() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Clip_Gradient()` function.");
      ...
      case 7:
        if (this->User_Controls__Regularization() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Regularization()` function.");
      ...
      case 8:
        if (this->User_Controls__Accuracy_Variance() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Accuracy_Variance()` function.");
      ...
      case 9:
        if (this->User_Controls__Time_Delays() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Time_Delays()` function.");
      ...
      case 11:
        if (this->User_Controls__Maximum__Batch_Size() == false) {
          ERR(L"An error has been triggered from the "
              L"`User_Controls__Maximum__Batch_Size()` function.");
      ...
      default:
        ERR(L"An error has been triggered from the "
            L"`parse_discrete(%d, %d)` function.", 0, 13);
        break;
    }
  }
