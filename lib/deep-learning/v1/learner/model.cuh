...
#include "deep-learning/data/enum/activation.hpp"
...
class cuModel {
 ...
 public:
  ...
  __host__ __device__ bool set_l1(
      var const regularization__l1_received);
  __host__ __device__ bool set_l2(
      var const regularization__l2_received);
  __host__ __device__ bool set_weight_decay(
  ...
  __host__ __device__ var get_l1(void) const;
  __host__ __device__ var get_l2(void) const;
