...
// clang-format off
template int DL::Term::parse_discrete<int>(int const, wchar_t const *const);
template long DL::Term::parse_discrete<long>(long const, wchar_t const *const);
template long long DL::Term::parse_discrete<long long>(long long const, wchar_t const *const);
...
template int DL::Term::parse_discrete<int>(int const, int const, wchar_t const *const);
template long DL::Term::parse_discrete<long>(long const, long const, wchar_t const *const);
template long long DL::Term::parse_discrete<long long>(long long const, long long const, wchar_t const *const);
