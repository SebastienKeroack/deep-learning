...
real Model::Initialization__Gain__Scale(
    ...
    switch(type)
    {
        ...
        case ACTIVATION::LEAKY_RELU: return sqrt(2_r / (1_r + pow(AF_LRELU_ALPHA, 2_r)));
        case ACTIVATION::PARAMETRIC_RELU: return sqrt(2_r / (1_r + pow(AF_PRELU_ALPHA, 2_r)));
        case ACTIVATION::RELU: return sqrt(2_r);
                                                                                ...
                                                                                LAYER_ACTIVATION::TYPE const type)
{
    switch(type)
    {
        ...
        case LAYER_ACTIVATION::SOFTMAX: // Xavier Glorot & Yoshua Bengio.
          return sqrt(2_r / static_cast<real>(n_inp + n_out));
        ...
        case LAYER_ACTIVATION::SELF_NORMALIZATION: // Self-Normalizing Neural Networks.
          return sqrt(1_r / static_cast<real>(n_inp));
        default:
