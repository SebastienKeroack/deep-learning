...
namespace DL::v1 {
void Model::RNN__Update_Derivative_Weight_Batch__Loop(size_t const batch_size,
                                                                                                     Layer *layer_it,
    ...
    for(; layer_it != last_layer; ++layer_it)
    {
        ...
        switch(layer_it->type_layer)
        {
            ...
            case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                this->Recurrent__Update_Derivative_Weight__FC__Loop(batch_size,
            ...
            case LAYER::LSTM:
                ...
                if(layer_it->Use__Bidirectional())
                {
                    ...
                    this->Recurrent__Update_Derivative_Weight__LSTM__Loop(true,
                                                                                                           batch_size,
                                                                                                           tmp_number_units[2],
                                                                                                           tmp_number_units[3],
                                                                                                           *prev_conn_layer->ptr_number_outputs,
                    ...
                    this->Recurrent__Update_Derivative_Weight__LSTM__Bias__Loop(batch_size,
                                                                                                                     tmp_number_units[2],
                                                                                                                     tmp_number_units[3],
                                                                                                                     layer_it->ptr_Bidirectional_Layer->forward_layer.ptr_array_cell_units->ptr_delta_cell_input,
                                                                                                                     layer_it->ptr_Bidirectional_Layer->forward_layer.ptr_array_block_units->ptr_delta_inputs_gates,
                    ...
                    this->Recurrent__Update_Derivative_Weight__LSTM__Loop(false,
                                                                                                           batch_size,
                                                                                                           tmp_number_units[2],
                                                                                                           tmp_number_units[3],
                                                                                                           *prev_conn_layer->ptr_number_outputs,
...
void Model::RNN__Update_Derivative_Weight_Batch__Pre_Training__Loop(size_t const batch_size)
{
    size_t tmp_number_units[4];
...
void Model::Recurrent__Update_Derivative_Weight__FC__Loop(size_t const batch_size,
                                                                                                          ...
                                                                                                          Layer *const layer_it)
{
    ...
    {
        this->Update_Derivative_Weight__FC__Loop(tmp_time_step_index,
                                                                         batch_size,
...
void Model::Update_Derivative_Weight__FC_Ind_RNN__Loop(size_t const time_step_index_received,
                                                                                                       ...
                                                                                                       real *const ptr_array_derivatives_received)
{
    ...
    {
        tmp_ptr_array_previous_timed_inputs = ptr_array_inputs_received + tmp_example_index * derivative_size_received + tmp_derivative_previous_timed_batched_index;
        ...
        for(tmp_derivative_index = 0_UZ; tmp_derivative_index != derivative_size_received; ++tmp_derivative_index) { ptr_array_derivatives_received[tmp_derivative_index] += cast(tmp_ptr_array_previous_timed_inputs[tmp_derivative_index]) * tmp_ptr_array_derivative_inputs[tmp_derivative_index]; }
    }
}

void Model::Recurrent__Update_Derivative_Weight__LSTM__Loop(bool const forward_layer_received,
                                                                                                              size_t const batch_size,
    ...
    for(tmp_example_index = 0_UZ; tmp_example_index != batch_size; ++tmp_example_index)
    {
        for(tmp_time_step_index = tmp_time_step_start; tmp_time_step_index != tmp_time_step_end; forward_layer_received ? ++tmp_time_step_index : --tmp_time_step_index)
        {
            if(tmp_time_step_index != tmp_time_prediction_end)
            {
                ...
                tmp_block_data_timed_index = tmp_example_index * block_unit_size_received + this->batch_size * block_unit_size_received * static_cast<size_t>(tmp_time_step_index);

                tmp_block_data_direction_timed_index = tmp_example_index * block_unit_size_received + this->batch_size * block_unit_size_received * tmp_time_step_direction_direction;

                tmp_cell_data_timed_index = tmp_example_index * cell_unit_size_received + this->batch_size * cell_unit_size_received * static_cast<size_t>(tmp_time_step_index);

                tmp_cell_data_direction_timed_index = tmp_example_index * cell_unit_size_received + this->batch_size * cell_unit_size_received * tmp_time_step_direction_direction;
                
                tmp_ptr_array_previous_layer_outputs = ptr_array_inputs_received + tmp_example_index * input_unit_size_received + this->batch_size * input_unit_size_received * static_cast<size_t>(tmp_time_step_index);
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 ++tmp_block_index)
                {
                                                                                                                                                                                           ...
                                                                                                                                                                                           ++tmp_cell_index)
                    {
                        ...
                        tmp_ptr_array_cell_input_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_cell_unit_it->first_index_feedforward_connection_cell_input;
                        ...
                        tmp_ptr_array_cell_input_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_cell_unit_it->first_index_recurrent_connection_cell_input;
                    ...
                    tmp_ptr_array_input_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_feedforward_connection_input_gate;
                    tmp_ptr_array_forget_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_feedforward_connection_forget_gate;
                    tmp_ptr_array_output_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_feedforward_connection_output_gate;
                    ...
                    tmp_ptr_array_input_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_peephole_input_gate;
                    tmp_ptr_array_forget_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_peephole_forget_gate;
                    tmp_ptr_array_output_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_peephole_output_gate;
                    ...
                    tmp_ptr_array_input_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_recurrent_connection_input_gate;
                    tmp_ptr_array_forget_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_recurrent_connection_forget_gate;
                    tmp_ptr_array_output_gate_derivatives_parameters = this->ptr_array_derivatives_parameters + tmp_ptr_block_unit_it->first_index_recurrent_connection_output_gate;
...
void Model::Recurrent__Update_Derivative_Weight__LSTM__Bias__Loop(size_t const batch_size,
                                                                                                                        ...
                                                                                                                        real *const ptr_array_output_gate_derivatives_bias_received)
{
    ...
    for(tmp_example_index = 0_UZ; tmp_example_index != batch_size; ++tmp_example_index)
    {
        ...
        {
            tmp_cell_data_timed_index = tmp_example_index * layer_cell_unit_size_received + this->batch_size * layer_cell_unit_size_received * static_cast<size_t>(tmp_time_step_index);

            tmp_block_data_timed_index = tmp_example_index * layer_block_unit_size_received + this->batch_size * layer_block_unit_size_received * static_cast<size_t>(tmp_time_step_index);

            for(tmp_cell_index = 0_UZ; tmp_cell_index != layer_cell_unit_size_received; ++tmp_cell_index)
            {
                ptr_array_cell_input_derivatives_bias_received[tmp_cell_index] += ptr_array_delta_block_inputs_received[tmp_cell_data_timed_index + tmp_cell_index];
            }

            for(tmp_block_index = 0_UZ; tmp_block_index != layer_block_unit_size_received; ++tmp_block_index)
            {
                ptr_array_input_gate_derivatives_bias_received[tmp_block_index] += ptr_array_delta_input_gates_received[tmp_block_data_timed_index + tmp_block_index];
                ptr_array_forget_gate_derivatives_bias_received[tmp_block_index] += ptr_array_delta_forget_gates_received[tmp_block_data_timed_index + tmp_block_index];
                ptr_array_output_gate_derivatives_bias_received[tmp_block_index] += ptr_array_delta_output_gates_received[tmp_block_data_timed_index + tmp_block_index];
            }
        }
    }
}
