...
template<typename T>
__global__ void kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons(size_t const data_index_received,
...
template<typename T>
__global__ void kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons(size_t const size_received,
...
template<typename T>
__global__ void kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                    size_t const data_index_received,
                                                                                                                                                                    size_t const number_neurons_received,
                                                                                                                                                                    size_t const next_layer_number_neurons_received,
                                                                                                                                                                    size_t const neurons_total_reduce_error_size_received,
...
template<typename T>
__global__ void kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Parallel_Neurons(size_t const number_neurons_received,
                                                                                                                                                        size_t const next_layer_number_neurons_received,
                                                                                                                                                        size_t const neurons_total_reduce_error_size_received,
                                                                                                                                                        T const *const ptr_array_next_layer_parameters_received,
                                                                                                                                                        T const *const ptr_array_next_layer_errors_received,
                                                                                                                                                        struct cuLayer *const layer_it)
{
    ...
    LAUNCH_KERNEL_POINTER_1D(Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T>,
...
template<typename T>
__global__ void kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                            size_t const number_neurons_received,
                                                                                                                                                            size_t const next_layer_number_neurons_received,
                                                                                                                                                            size_t const neurons_total_reduce_error_size_received,
                                                                                                                                                            T const *const ptr_array_next_layer_parameters_received,
...
template<typename T>
__global__ void kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                     size_t const number_neurons_received,
                                                                                                                                                                     size_t const next_layer_number_neurons_received,
                                                                                                                                                                     size_t const neurons_total_reduce_error_size_received,
                                                                                                                                                                     T const *const ptr_array_next_layer_parameters_received,
                                                                                                                                                                     ...
                                                                                                                                                                     struct cuLayer *const layer_it)
{
    ...
    if(layer_it->ptr_dim3_grid_neurons->x * layer_it->ptr_dim3_block_neurons->x < number_neurons_received - 1u) // Subtract bias.
    {
        ...
        do
        {
            ...
            kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (number_neurons_received - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                        tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                        number_neurons_received,
                                                                                                                                                                                                                                                                                                        next_layer_number_neurons_received,
                                                                                                                                                                                                                                                                                                        neurons_total_reduce_error_size_received,
    ...
    else if(layer_it->ptr_dim3_grid_neurons->x * layer_it->ptr_dim3_block_neurons->x > number_neurons_received - 1u) // Subtract bias.
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (number_neurons_received - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                number_neurons_received,
                                                                                                                                                                                                                                                                                                next_layer_number_neurons_received,
                                                                                                                                                                                                                                                                                                neurons_total_reduce_error_size_received,
    ...
    else
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                number_neurons_received,
                                                                                                                                                                                                                                                                                                next_layer_number_neurons_received,
                                                                                                                                                                                                                                                                                                neurons_total_reduce_error_size_received,
                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_mask_dropout_bernoulli,
...
template<typename T>
__global__ void kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Serialize_Neurons(size_t const number_neurons_received,
                                                                                                                                                            size_t const next_layer_number_neurons_received,
                                                                                                                                                            size_t const neurons_total_reduce_error_size_received,
...
template<typename T>
__global__ void kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                            size_t const number_neurons_received,
                                                                                                                                                            size_t const next_layer_number_neurons_received,
                                                                                                                                                            size_t const neurons_total_reduce_error_size_received,
                                                                                                                                                            T const *ptr_array_next_layer_parameters_received,
...
template<typename T>
__global__ void kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                                    size_t const number_neurons_received,
                                                                                                                                                                    size_t const next_layer_number_neurons_received,
                                                                                                                                                                    size_t const neurons_total_reduce_error_size_received,
                                                                                                                                                                    T const *const ptr_array_next_layer_parameters_received,
...
__device__ void cuModel::Backward_Pass__FC_to_FC__Dropout(bool &ref_synchronized_received,
                                                                                                                    ...
                                                                                                                    struct dim3 const *const ptr_dim3_batch_size_block_received)
{
    ...
    if(USE_PARALLEL && batch_size >= warpSize)
    {
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Parallel_Neurons<var>,
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Serialize_Neurons<var>,
                                                              ptr_dim3_batch_size_grid_received,
                                                              ptr_dim3_batch_size_block_received,
                                                              0_UZ,
                                                              batch_size,
    ...
    if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize)
    {
        ...
        if(layer_it->ptr_dim3_grid_neurons_DP->x * layer_it->ptr_dim3_block_neurons_DP->x < tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                            tmp_data_index,
                                                                                                                                                                                                                                                                                                                                            tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                            tmp_next_layer_number_neurons,
                                                                                                                                                                                                                                                                                                                                            this->neurons_total_reduce_error_size,
        ...
        else if(layer_it->ptr_dim3_grid_neurons_DP->x * layer_it->ptr_dim3_block_neurons_DP->x > tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                    tmp_data_index,
                                                                                                                                                                                                                                                                                                                                    tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                    tmp_next_layer_number_neurons,
                                                                                                                                                                                                                                                                                                                                    this->neurons_total_reduce_error_size,
