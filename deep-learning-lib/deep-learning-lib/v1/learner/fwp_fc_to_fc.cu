                                                                                                                                            ...
                                                                                                                                            struct dim3 const *const ptr_array_dim3_block_reduce_summations_received)
{
    ...
    if(tmp_thread_global_index < size_received)
    {
        ...
        INFO(L"tmp_thread_global_index: %u", tmp_thread_global_index);
        Reduce::Reduce_XX<T>(number_connections_received,
                                            number_neurons_received,
                                            tmp_ptr_array_reduce_summation,
                                            tmp_ptr_array_parameters,
                                                                                                                                                ...
                                                                                                                                                struct cuLayer *const layer_it)
{
    ...
    if(layer_it->ptr_dim3_grid_neurons->x * layer_it->ptr_dim3_block_neurons->x < number_neurons_received - 1u) // Subtract bias.
    {
        ...
        do
        {
            ...
            kernel_while__Forward_Pass__FC_to_FC__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (number_neurons_received - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                        tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                        number_neurons_received,
                                                                                                                                                                                                                                                                                                        number_connections_received,
                                                                                                                                                                                                                                                                                                        neurons_total_reduce_summation_size_received,
    ...
    else if(layer_it->ptr_dim3_grid_neurons->x * layer_it->ptr_dim3_block_neurons->x > number_neurons_received - 1u) // Subtract bias.
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__Forward_Pass__FC_to_FC__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (number_neurons_received - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                number_neurons_received,
                                                                                                                                                                                                                                                                                                number_connections_received,
                                                                                                                                                                                                                                                                                                neurons_total_reduce_summation_size_received,
    ...
    else
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__Forward_Pass__FC_to_FC__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                number_neurons_received,
                                                                                                                                                                                                                                                                                                number_connections_received,
                                                                                                                                                                                                                                                                                                neurons_total_reduce_summation_size_received,
                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_array_summations + tmp_thread_global_index * number_neurons_received,
...
__device__ void cuModel::Forward_Pass__FC_to_FC(bool &ref_synchronized_received,
                                                                                                    ...
                                                                                                    struct dim3 const *const ptr_dim3_batch_size_block_received)
{
    ...
    if(USE_PARALLEL && batch_size >= warpSize && layer_it == this->ptr_array_layers + 1)
    {
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(Forward_Pass__FC_to_FC__Parallel_Batch__Parallel_Neurons<var>,
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(Forward_Pass__FC_to_FC__Parallel_Batch__Serialize_Neurons<var>,
                                                              ptr_dim3_batch_size_grid_received,
                                                              ptr_dim3_batch_size_block_received,
                                                              0_UZ,
                                                              batch_size,
    ...
    else if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize || true)
    {
        ...
        if(layer_it->ptr_dim3_grid_neurons_DP->x * layer_it->ptr_dim3_block_neurons_DP->x < tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel_while__Forward_Pass__FC_to_FC__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                           tmp_data_index,
                                                                                                                                                                                                                                                                                                                           tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                           tmp_number_connections,
                                                                                                                                                                                                                                                                                                                           this->neurons_total_reduce_summation_size,
        ...
        else if(layer_it->ptr_dim3_grid_neurons_DP->x * layer_it->ptr_dim3_block_neurons_DP->x > tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__Forward_Pass__FC_to_FC__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                tmp_data_index,
                                                                                                                                                                                                                                                                                                                tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                tmp_number_connections,
                                                                                                                                                                                                                                                                                                                this->neurons_total_reduce_summation_size,
        ...
        else
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__Forward_Pass__FC_to_FC__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_data_index,
                                                                                                                                                                                                                                                                                                                  tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                  tmp_number_connections,
                                                                                                                                                                                                                                                                                                                  this->neurons_total_reduce_summation_size,
                                                                                                                                                                                                                                                                                                                  tmp_ptr_layer_it_first_neuron->ptr_array_summations + tmp_data_index * tmp_number_neuron_units,
...
[[deprecated("Not properly implemented.")]] __device__ void cuModel::Forward_Pass__FC_to_FC__Softmax(bool &ref_synchronized_received,
                                                                                                                  size_t const batch_size,
                                                                                                                  struct cuLayer *const layer_it,
                                                                                                                  struct cuLayer const *const ptr_previous_layer_it_received,
                                                                                                                  struct dim3 const *const ptr_dim3_batch_size_grid_received,
                                                                                                                  struct dim3 const *const ptr_dim3_batch_size_block_received)
{
    /*
    struct cuNeuron const *const tmp_ptr_last_neuron_unit(layer_it->ptr_last_neuron_unit - 1); // Subtract bias.
    struct cuNeuron *tmp_ptr_neuron_unit_it(layer_it->ptr_array_neuron_units);
    ...
    var const *const tmp_ptr_array_previous_layer_outputs(ptr_previous_layer_it_received->ptr_array_neuron_units->ptr_array_values + thread_index_received * (tmp_number_connections + 1u)), // Add bias.
                  *tmp_ptr_array_parameters(this->ptr_array_parameters + *tmp_ptr_neuron_unit_it->ptr_first_forward_connection_index);
    var tmp_summation(0),
         tmp_layer_maximum_summation(DL::Math::NUMERIC_LIMITS_MIN<var>),
        *tmp_ptr_array_reduce_summation;
    ...
    if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize)
    {
        ...
        LAUNCH_KERNEL_POINTER_1D(Forward_Pass__FC_to_FC__Softmax__Summation<var>,
                                                            layer_it->ptr_dim3_grid_neurons,
                                                            layer_it->ptr_dim3_block_neurons,
                                                            0_UZ,
    ...
    else
    {
        ...
        for(tmp_ptr_neuron_unit_it = layer_it->ptr_array_neuron_units; tmp_ptr_neuron_unit_it != tmp_ptr_last_neuron_unit; ++tmp_ptr_neuron_unit_it)
        {
            ...
            tmp_layer_maximum_summation = std::max(tmp_layer_maximum_summation, tmp_ptr_neuron_unit_it->ptr_array_summations[thread_index_received * tmp_number_neuron_units]);
        }
    
        // Loop through each neurons for activation function.
        for(tmp_ptr_neuron_unit_it = layer_it->ptr_array_neuron_units; tmp_ptr_neuron_unit_it != tmp_ptr_last_neuron_unit; ++tmp_ptr_neuron_unit_it)
        {
            if(*tmp_ptr_neuron_unit_it->ptr_type_activation_function != DL::ENUM_TYPE_ACTIVATION_FUNCTIONS::SOFTMAX)
            {
                ERR(L"Can not use a activation function different than softmax.");
