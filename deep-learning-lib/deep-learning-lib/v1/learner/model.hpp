...
#include "deep-learning-lib/v1/data/enum/group.hpp"
...
#include "deep-learning-lib/v1/data/enum/hyperopt.hpp"
...
#include "deep-learning-lib/v1/data/enum/initializer.hpp"
...
class Model {
 public:
  ...
  bool Set__Accurancy_Variance(double const accurancy_variance_received);
  ...
  bool Set__Alpha_Sparsity(Layer *const ptr_layer_received,
                           real const alpha_sparsity_received);
  bool Set__Regularization__L1(real const regularization__l1_received);
  bool Set__Regularization__L2(real const regularization__l2_received);
  bool Set__Regularization__SRIP(real const regularization__l2_received);
  bool Set__Regularization__Weight_Decay(
  ...
  real Get__Regularization__L1(void) const;
  real Get__Regularization__L2(void) const;
  real Get__Regularization__SRIP(void) const;
