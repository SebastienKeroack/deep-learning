...
namespace DL::v1 {
void Model::RNN__Backward_Pass_Batch__Loop(size_t const batch_size)
{
    ...
    for(; tmp_ptr_gradient_layer_it != tmp_ptr_second_layer; --tmp_ptr_gradient_layer_it)
    {
            ...
            next_layer_end = next_layer_it + layer_it->next_connected_layers.size(); next_layer_it != next_layer_end; ++next_layer_it)
        {
            switch(next_layer_it->type_layer)
            {
                case LAYER::AVERAGE_POOLING:
                    this->Recurrent__Backward_Pass__Average_Pooling__Loop(batch_size,
                ...
                case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                    this->Recurrent__Backward_Pass__FC__Loop(batch_size,
                                                                                         tmp_layer_number_outputs,
                                                                                         tmp_ptr_array_layer_gradients,
                                                                                         next_layer_it);
                        break;
                case LAYER::LSTM:
                    this->Recurrent__Backward_Pass__LSTM__Loop(batch_size,
                                                                                             tmp_layer_number_outputs,
                                                                                             tmp_ptr_array_layer_gradients,
                                                                                             next_layer_it);
                        break;
                case LAYER::MAX_POOLING:
                    this->Recurrent__Backward_Pass__Max_Pooling__Loop(batch_size,
                                                                                                       tmp_layer_number_outputs,
                                                                                                       tmp_ptr_array_layer_gradients,
                                                                                                       next_layer_it);
                        break;
                case LAYER::RESIDUAL:
                    this->Recurrent__Backward_Pass__Residual__Loop(batch_size,
                                                                                                 tmp_layer_number_outputs,
                                                                                                 tmp_ptr_array_layer_gradients,
                                                                                                 next_layer_it);
                        break;
        ...
        switch(layer_it->type_layer)
        {
            ...
            case LAYER::FULLY_CONNECTED:
            case LAYER::FULLY_CONNECTED_RECURRENT:
            case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT: this->Recurrent__Backward_Pass__Gradient__FC__Loop(batch_size, layer_it); break;
            case LAYER::LSTM:
                ...
                else
                {
                    ...
                    break;
            case LAYER::RESIDUAL:
                this->Recurrent__Backward_Pass__Gradient__Residual__Loop(batch_size, layer_it);
...
void Model::RNN__Backward_Pass_Batch__Pre_Training__Loop(size_t const batch_size)
{
    size_t tmp_layer_number_outputs;
    ...
    switch(tmp_ptr_coded_layer->type_layer)
    {
        case LAYER::FULLY_CONNECTED:
        case LAYER::FULLY_CONNECTED_RECURRENT:
        case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT: this->Recurrent__Backward_Pass__Gradient__FC__Loop(batch_size, tmp_ptr_coded_layer); break;
        case LAYER::LSTM:
...
void Model::Recurrent__Backward_Pass__Average_Pooling__Loop(size_t const batch_size,
...
void Model::Recurrent__Backward_Pass__FC__Loop(size_t const batch_size,
                                                                                            size_t const derivative_size_received,
                                                                                            real *const ptr_array_derivatives_received,
                                                                                            Layer const *const layer_it)
{
...
void Model::Recurrent__Backward_Pass__LSTM__Loop(size_t const batch_size,
                                                                                                size_t const derivative_size_received,
                                                                                                real *const ptr_array_derivatives_received,
                                                                                                Layer const *const layer_it)
{
...
void Model::Recurrent__Backward_Pass__Max_Pooling__Loop(size_t const batch_size,
                                                                                                          size_t const derivative_size_received,
                                                                                                          real *const ptr_array_derivatives_received,
                                                                                                          Layer const *const layer_it)
{
...
void Model::Recurrent__Backward_Pass__Residual__Loop(size_t const batch_size,
                                                                                                    size_t const derivative_size_received,
                                                                                                    real *const ptr_array_derivatives_received,
                                                                                                    Layer const *const layer_it)
{
...
void Model::Recurrent__Backward_Pass__Residual__Block__Loop(size_t const batch_size,
                                                                                                                size_t const derivative_size_received,
                                                                                                                real *const ptr_array_derivatives_received,
                                                                                                                Layer const *const layer_it)
{
...
void Model::Recurrent__Backward_Pass__Gradient__FC__Loop(size_t const batch_size, Layer const *const layer_it)
{
    for(size_t tmp_time_step_index(this->seq_w); tmp_time_step_index--;)
    {
...
void Model::Recurrent__Backward_Pass__Gradient__LSTM__Loop(bool const forward_layer_received,
                                                                                                                ...
                                                                                                                Layer *const layer_it)
{
    ...
    for(tmp_time_step_index = tmp_time_step_start; tmp_time_step_index != tmp_time_step_end; forward_layer_received ? --tmp_time_step_index : ++tmp_time_step_index)
    {
        ...
        {
            // memcpy.
          memcpy(tmp_ptr_layer_first_cell_unit->ptr_delta_cell_input_input +
            ...
            memcpy(tmp_ptr_layer_first_block_unit->ptr_delta_input_inputs_gates +
                     this->batch_size * tmp_number_block_units *
                         tmp_time_step_index,
...
void Model::Recurrent__Backward_Pass__Gradient__Residual__Loop(size_t const batch_size, Layer const *const layer)
{
...
void Model::Recurrent__Backward_Pass__Gradient__Residual__Layer__Loop(bool const is_block_input_layer_received,
                                                                                                                               size_t const batch_size,
                                                                                                                               Layer *&layer_it)
{
    ...
    switch(next_layer_it->type_layer)
    {
        ...
        case LAYER::MAX_POOLING:
            this->Recurrent__Backward_Pass__Max_Pooling__Loop(batch_size,
                ...
                break;
        case LAYER::RESIDUAL:
            this->Recurrent__Backward_Pass__Residual__Block__Loop(batch_size,
                                                                                                    tmp_layer_number_outputs,
                                                                                                    tmp_ptr_array_layer_gradients,
                                                                                                    next_layer_it);
                break;
...
void Model::Recurrent__Backward_Pass__Gradient__Residual__FC__Loop(bool const is_block_input_layer_received,
                                                                                                                           size_t const batch_size,
                                                                                                                           Layer const *const layer_it)
{
    for(size_t tmp_time_step_index(this->seq_w); tmp_time_step_index--;)
...
void Model::Backward_Pass__LSTM__Loop(size_t const time_step_index_received,
                                                                              size_t const batch_size,
                                                                              size_t const derivative_input_size_received,
...
void Model::Backward_Pass__LSTM_Derivative__Output__Loop(long long int const time_step_index_received,
...
void Model::Backward_Pass__LSTM_Derivative__Cell_State_AF__Loop(long long int const time_step_index_received,
                                                                                                                      long long int const time_step_direction_received,
...
void Model::Backward_Pass__LSTM_Derivative__Gates_CIF_AF_State__Loop(long long int const time_step_index_received,
                                                                                                                                long long int const time_step_direction_received,
                                                                                                                                ...
                                                                                                                                Layer *const layer_it)
{
    ...
    real tmp_input_gate_activation,
