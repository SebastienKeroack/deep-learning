...
bool Model::Reallocate__Parameter(size_t const number_parameters_received)
{
    if(this->total_parameters_allocated != 0u)
    {
        ...
        if(this->ptr_array_ptr_connections != nullptr)
        {
            ...
            {
                ERR(L"An error has been triggered from the \"reallocate_pointers_array_cpp<%zu>(ptr, %zu, %zu, true)\" function.",
                                         sizeof(void*),
                                         number_parameters_received,
                                         this->total_parameters_allocated);
        ...
        if(this->ptr_array_parameters != nullptr)
        {
            ...
            {
                ERR(L"An error has been triggered from the \"Reallocate__Parameter__Optimizer(%zu)\" function.",
                                         number_parameters_received);
            ...
            {
                ERR(L"An error has been triggered from the \"Reallocate__Parameter__Regularization(%zu)\" function.",
                                         number_parameters_received);
...
bool Model::Reallocate__Parameter__iRPROP_plus(size_t const number_parameters_received)
{
    ...
    {
        ERR(L"An error has been triggered from the \"Reallocate__Parameter__iRPROP_minus()\" function.",);
...
bool Model::Reallocate__Parameter__AMSGrad(size_t const number_parameters_received)
{
    ...
    {
        ERR(L"An error has been triggered from the \"Reallocate__Parameter__Adam()\" function.",);
