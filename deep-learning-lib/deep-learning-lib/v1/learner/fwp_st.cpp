...
namespace DL::v1 {
void Model::forward_pass(size_t const batch_size,
                                                     ...
                                                     long long int output_layer_index_received)
{
    ...
    {
        ERR(L"Input layer index (%lld) can not be greater or equal to the output layer index(%lld).",
    ...
    switch(this->type)
    {
        case MODEL::AUTOENCODER:
            ...
            {
                this->Forward_Pass__Pre_Training(batch_size, ptr_array_inputs_received);
        ...
        default:
            if(this->seq_w > 1_UZ)
            {
                ...
                {
                    this->RNN__Forward_Pass_Batch__OpenMP(batch_size,
                ...
                {
                    this->RNN__Forward_Pass_Batch__Loop(batch_size,
                                                                                 ptr_array_inputs_received,
                                                                                 this->ptr_array_layers + input_layer_index_received,
                                                                                 this->ptr_array_layers + output_layer_index_received);
                }
            ...
            else
            {
                if(this->use_mp && this->is_mp_initialized)
                {
                    this->FF__Forward_Pass_Batch__OpenMP(batch_size,
                                                                                    ptr_array_inputs_received,
                                                                                    this->ptr_array_layers + input_layer_index_received,
                                                                                    this->ptr_array_layers + output_layer_index_received);
                }
                ...
                {
                    this->FF__Forward_Pass_Batch__Loop(batch_size,
                                                                              ptr_array_inputs_received,
                                                                              this->ptr_array_layers + input_layer_index_received,
                                                                              this->ptr_array_layers + output_layer_index_received);
                }
...
void Model::Forward_Pass__Pre_Training(
    ...
    {
        if(this->use_mp && this->is_mp_initialized)
        { this->RNN__Forward_Pass_Batch__Pre_Training__OpenMP(batch_size, ptr_array_inputs_received); }
        else
        { this->RNN__Forward_Pass_Batch__Pre_Training__Loop(batch_size, ptr_array_inputs_received); }
    }
    else
    {
        if(this->use_mp && this->is_mp_initialized)
        { this->FF__Forward_Pass_Batch__Pre_Training__OpenMP(batch_size, ptr_array_inputs_received); }
        else
        { this->FF__Forward_Pass_Batch__Pre_Training__Loop(batch_size, ptr_array_inputs_received); }
    }
}

void Model::FF__Forward_Pass_Batch__Loop(size_t const batch_size,
    real const *const *const ptr_array_inputs_received,
                                                                                 ...
                                                                                 Layer const *const last_layer)
{
    ...
    // Input layer.
    this->assign_inputs_fwp_st(batch_size, ptr_array_inputs_received);
    // |END| Input layer. |END|
    ...
    for(; layer_it != last_layer; ++layer_it)
    {
        ...
        switch(layer_it->type_layer)
        {
            case LAYER::AVERAGE_POOLING:
                this->Forward_Pass__Average_Pooling__Loop(0_UZ,
                                                                                    batch_size,
            ...
            case LAYER::FULLY_CONNECTED:
                this->Forward_Pass__FC__Loop(0_UZ,
                                                                batch_size,
                                                                *prev_conn_layer->ptr_number_outputs,
                                                                prev_conn_layer->ptr_array_outputs,
                                                                layer_it);
            ...
            case LAYER::MAX_POOLING:
                this->Forward_Pass__Max_Pooling__Loop(0_UZ,
                                                                               batch_size,
                                                                               *prev_conn_layer->ptr_number_outputs,
                                                                               prev_conn_layer->ptr_array_outputs,
                                                                               layer_it);
                    break;
            case LAYER::RESIDUAL: this->Forward_Pass__Residual__Loop(batch_size, layer_it); break;
            default:
...
void Model::FF__Forward_Pass_Batch__Pre_Training__Loop(
    size_t const batch_size,
    real const *const *const ptr_array_inputs_received) {
    ...
    // Input layer.
    this->assign_inputs_pre_train_fwp_st(batch_size, ptr_array_inputs_received);
    // |END| Input layer. |END|
    ...
    for(; layer_it != last_layer; ++layer_it)
    {
        ...
        switch(layer_it->type_layer)
        {
                    break;
            case LAYER::FULLY_CONNECTED:
                this->Forward_Pass__Encode__FC__Loop(0_UZ,
                                                                               batch_size,
                                                                               *prev_conn_layer->ptr_number_outputs,
                                                                               prev_conn_layer->ptr_array_outputs,
                                                                               layer_it);
    ...
    {
        case LAYER::FULLY_CONNECTED:
            this->Forward_Pass__Code__FC__Loop(0_UZ,
                                                                       batch_size,
                                                                       *prev_conn_layer->ptr_number_outputs,
                                                                       prev_conn_layer->ptr_array_outputs,
                                                                       layer_it);
    ...
    {
        case LAYER::FULLY_CONNECTED:
            this->Forward_Pass__Decode__FC__Loop(0_UZ,
                                                                           batch_size,
                                                                           *prev_conn_layer->ptr_number_outputs,
                                                                           prev_conn_layer->ptr_array_outputs,
                                                                           layer_it);
...
void Model::Forward_Pass__Average_Pooling__Loop(size_t const time_step_index_received,
                                                                                           size_t const batch_size,
...
void Model::Forward_Pass__FC__Loop(size_t const time_step_index_received,
                                                                       size_t const batch_size,
                                                                       size_t const input_size_received,
                                                                       var const *const ptr_array_inputs_received,
                                                                       Layer *const layer_it)
            ...
            switch(layer_it->type_activation)
            {
                ...
                case LAYER_ACTIVATION::SOFTMAX: // Only output layer.
                    this->Forward_Pass__FC_AF__Softmax__Loop(time_step_index_received,
                        ...
                        break;
                default:
                    ERR(L"Layer activation (%u | %ls) is not managed in",
    ...
    if(this->type_state_propagation == PROPAGATION::TRAINING)
    {
        ...
        switch(layer_it->type_dropout)
        {
            case LAYER_DROPOUT::BERNOULLI:
                this->Forward_Pass__Dropout__Bernoulli__Training__Loop(layer_it->ptr_array__mask__dropout__bernoulli,
            ...
            case LAYER_DROPOUT::BERNOULLI_INVERTED:
                this->Forward_Pass__Dropout__Bernoulli__Inverted__Loop(layer_it->ptr_array__mask__dropout__bernoulli,
                                                                                                      time_step_index_received,
                                                                                                      batch_size,
                                                                                                      tmp_output_size,
...
void Model::Forward_Pass__Encode__FC__Loop(size_t const time_step_index_received,
                                                                                      size_t const batch_size,
                                                                                      size_t const input_size_received,
                                                                                      var const *const ptr_array_inputs_received,
                                                                                      Layer *const layer_it)
...
void Model::Forward_Pass__Code__FC__Loop(size_t const time_step_index_received,
                                                                                  size_t const batch_size,
                                                                                  size_t const input_size_received,
                                                                                  var const *const ptr_array_inputs_received,
                                                                                  Layer *const layer_it)
...
void Model::Forward_Pass__Decode__FC__Loop(size_t const time_step_index_received,
                                                                                      size_t const batch_size,
                                                                                      size_t const input_size_received,
                                                                                      var const *const ptr_array_inputs_received,
                                                                                      Layer *const layer_it)
{
    ...
    Layer const *const tmp_ptr_input_layer(this->ptr_array_layers + (this->pre_training_level - 1_UZ));
...
void Model::Forward_Pass__LSTM__Loop(long long int const time_step_index_received,
...
void Model::Forward_Pass__Encode__LSTM__Loop(long long int const time_step_index_received,
                                                                                          long long int const tmp_time_step_reverse_direction,
                                                                                          long long int const tmp_time_step_start,
                                                                                          size_t const batch_size,
                                                                                          size_t const input_size_received,
...
void Model::Forward_Pass__Code__LSTM__Loop(long long int const time_step_index_received,
                                                                                       long long int const tmp_time_step_reverse_direction,
                                                                                       long long int const tmp_time_step_start,
                                                                                       size_t const batch_size,
                                                                                       size_t const input_size_received,
...
void Model::Forward_Pass__Decode__LSTM__Loop(long long int const time_step_index_received,
                                                                                          long long int const tmp_time_step_reverse_direction,
                                                                                          long long int const tmp_time_step_start,
                                                                                          size_t const batch_size,
                                                                                          size_t const input_size_received,
...
void Model::Forward_Pass__Max_Pooling__Loop(size_t const time_step_index_received,
                                                                                      size_t const batch_size,
                                                                                      size_t const input_size_received,
                                                                                      var const *const ptr_array_inputs_received,
                                                                                      Layer *const layer_it)
...
void Model::Forward_Pass__Residual__Loop(size_t const batch_size, Layer *&layer_it)
{
    var *tmp_ptr_array_inputs;
    ...
    if(tmp_ptr_residual_layer->Use__Normalization())
    {
        ...
        if(this->type_state_propagation >= PROPAGATION::TRAINING)
        {
            ...
            {
                case LAYER_NORM::BATCH_NORMALIZATION:
                    this->Forward_Pass__Batch_Normalization__Training__Loop(0_UZ,
                                                                                                             batch_size,
                                                                                                             *layer_it->ptr_number_outputs,
                                                                                                             tmp_ptr_array_inputs,
                        ...
                        break;
                case LAYER_NORM::BATCH_RENORMALIZATION:
                    this->Forward_Pass__Batch_Renormalization__Training__Loop(0_UZ,
                                                                                                                batch_size,
                                                                                                                *layer_it->ptr_number_outputs,
                                                                                                                tmp_ptr_array_inputs,
                                                                                                                tmp_ptr_residual_first_normalized_unit->normalized_batch_units.ptr_scale,
        ...
        {
            this->Forward_Pass__Batch_Normalization__Inference__Loop(0_UZ,
                                                                                                      batch_size,
                                                                                                      *layer_it->ptr_number_outputs,
                                                                                                      tmp_ptr_array_inputs,
                                                                                                      tmp_ptr_residual_first_normalized_unit->normalized_batch_units.ptr_scale,
    ...
    if(tmp_ptr_residual_layer->type_dropout == LAYER_DROPOUT::SHAKEDROP)
    {
        ...
        if(this->type_state_propagation == PROPAGATION::TRAINING)
        {
            this->Forward_Pass__Dropout__ShakeDrop__Loop(0_UZ,
                                                                                       batch_size,
                                                                                       *layer_it->ptr_number_outputs,
        ...
        {
            this->Forward_Pass__Dropout__Bernoulli__Inference__Loop(0_UZ,
                                                                                                    batch_size,
                                                                                                    *layer_it->ptr_number_outputs,
    ...
    this->Forward_Pass__Zero_Padded_Identity__Loop(0_UZ,
                                                                               batch_size,
...
void Model::Forward_Pass__Residual__Layer__Loop(bool const is_block_input_layer_received,
                                                                                           size_t const batch_size,
                                                                                           Layer *&layer_it)
{
...
void Model::Forward_Pass__Residual__FC__Loop(bool const is_block_input_layer_received,
...
void Model::Forward_Pass__Bias__Loop(size_t const time_step_index_received,
                                                                          size_t const batch_size,
                                                                          size_t const output_size_received,
...
void Model::Forward_Pass__Batch_Normalization__Inference__Loop(size_t const time_step_index_received,
                                                                                                                 size_t const batch_size,
                                                                                                                 size_t const input_size_received,
                                                                                                                 var const *const ptr_array_inputs_received,
...
void Model::Forward_Pass__Batch_Normalization__Training__Loop(size_t const time_step_index_received,
                                                                                                                size_t const batch_size,
                                                                                                                size_t const input_size_received,
                                                                                                                var const *const ptr_array_inputs_received,
                                                                                                                var const *const ptr_array_scales_received,
...
void Model::Forward_Pass__Batch_Renormalization__Training__Loop(size_t const time_step_index_received,
                                                                                                                   size_t const batch_size,
                                                                                                                   size_t const input_size_received,
                                                                                                                   var const *const ptr_array_inputs_received,
                                                                                                                   var const *const ptr_array_scales_received,
                                                                                                                   ...
                                                                                                                   var *const ptr_array_output_normalizes_received)
{
    ...
    for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index)
    {
        ...
        ptr_array_r_corrections_received[tmp_input_timed_index + tmp_input_index] = Math::clip<var>(tmp_gamma, tmp_r_correction, tmp_r_correction_maximum);
        ...
        ptr_array_d_corrections_received[tmp_input_timed_index + tmp_input_index] = Math::clip<var>(tmp_d_correction, -tmp_d_correction_maximum, tmp_d_correction_maximum);
    }
...
void Model::Forward_Pass__FC_AF__Loop(size_t const time_step_index_received,
                                                                             size_t const batch_size,
                                                                             size_t const input_size_received,
                                                                             var const *const ptr_array_inputs_received,
                                                                             var *const ptr_array_outputs_received,
...
void Model::Forward_Pass__FC_AF__Softmax__Loop(size_t const time_step_index_received,
                                                                                             size_t const batch_size,
                                                                                             size_t const input_size_received,
                                                                                             var const *const ptr_array_inputs_received,
                                                                                             var *const ptr_array_outputs_received)
{
    ...
    for(tmp_example_index = 0_UZ; tmp_example_index != batch_size; ++tmp_example_index)
    {
        ...
        for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_layer_maximum_summation = std::max<var>(tmp_layer_maximum_summation, tmp_ptr_array_inputs[tmp_input_index]); }
        
        for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_summation += tmp_ptr_array_outputs[tmp_input_index] = exp(tmp_ptr_array_inputs[tmp_input_index] - tmp_layer_maximum_summation); }
...
void Model::Forward_Pass__Dropout__Bernoulli__Inverted__Loop(bool const *const ptr_array__mask__dropout__bernoulli_received,
                                                                                                             size_t const time_step_index_received,
                                                                                                             size_t const batch_size,
                                                                                                             size_t const input_size_received,
...
void Model::Forward_Pass__Dropout__Bernoulli__Training__Loop(bool const *const ptr_array__mask__dropout__bernoulli_received,
                                                                                                             size_t const time_step_index_received,
                                                                                                             size_t const batch_size,
                                                                                                             size_t const input_size_received,
                                                                                                             var *const ptr_array_inputs_received)
...
void Model::Forward_Pass__Dropout__Bernoulli__Inference__Loop(size_t const time_step_index_received,
                                                                                                               size_t const batch_size,
                                                                                                               size_t const input_size_received,
...
void Model::Forward_Pass__Dropout__Gaussian__Loop(size_t const time_step_index_received,
                                                                                                size_t const batch_size,
                                                                                                size_t const input_size_received,
                                                                                                real const variance,
                                                                                                var *const ptr_array_inputs_received)
{
    ...
    this->ptr_array_Class_Generator_Real_Gaussian->range(1_r, variance);

    for(tmp_example_index = 0_UZ; tmp_example_index != batch_size; ++tmp_example_index)
    {
        tmp_ptr_array_inputs = ptr_array_inputs_received + tmp_example_index * input_size_received + tmp_input_timed_batched_index;

        for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_ptr_array_inputs[tmp_input_index] *= (*this->ptr_array_Class_Generator_Real_Gaussian)(); }
    }
}

void Model::Forward_Pass__Dropout__ShakeDrop__Loop(size_t const time_step_index_received,
                                                                                                  size_t const batch_size,
                                                                                                  size_t const input_size_received,
                                                                                                  ...
                                                                                                  var *const ptr_array_inputs_received)
{
    ...
    for(tmp_example_index = 0_UZ; tmp_example_index != batch_size; ++tmp_example_index)
    {
        if((ptr_array_mask_dopout_shakedrop_received[tmp_layer_timed_batched_index + tmp_example_index] = (*this->ptr_array_Class_Generator_Bernoulli_ShakeDrop)()))
        {
            ...
            for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_ptr_array_inputs[tmp_input_index] *= (*this->ptr_array_Class_Generator_Real_ShakeDrop)(); }
        }
    }
}

void Model::Forward_Pass__Dropout__Uout__Loop(size_t const time_step_index_received,
                                                                                         size_t const batch_size,
                                                                                         size_t const input_size_received,
                                                                                         ...
                                                                                         var *const ptr_array_inputs_received)
{
    ...
    for(tmp_example_index = 0_UZ; tmp_example_index != batch_size; ++tmp_example_index)
    {
        ...
        for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_ptr_array_inputs[tmp_input_index] += tmp_ptr_array_inputs[tmp_input_index] * (*this->ptr_array_Class_Generator_Real_Uout)(); }
    }
}
...
void Model::Forward_Pass__Zero_Padded_Identity__Loop(size_t const time_step_index_received,
                                                                                                  size_t const batch_size,
