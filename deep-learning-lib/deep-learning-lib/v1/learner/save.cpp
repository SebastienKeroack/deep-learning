...
bool Model::save_spec_params(std::wstring const &path_name) {
  ...
  std::wofstream file(path_name, std::ios::out | std::ios::binary);
  ...
  file.write(inp.c_str(), inp.size());

  if (file.fail()) {
    ERR(L"An error has been triggered from the \"write(string, %zu)\" "
        L"function. Logical error on i/o operation \"%ls\".",
...
bool Model::save_params(std::wstring const &path_name) {
  ...
  if (this->is_cu_initialized && this->is_update_from_device == false) {
    if (this->Copy__Parameters__Device_To_Host() == false) {
      ERR(L"An error has been triggered from the \"Copy__Parameters__Device_To_Host(%ls)\" function.");
    } else if (this->Use__Normalization() &&
               this->Copy__Batch_Normalization_Neurons__Device_To_Host() == false) {
      ERR(L"An error has been triggered from the \"Copy__Batch_Normalization_Neurons__Device_To_Host(%ls)\" function.");
    }
  }
#endif
  // clang-format off
    ...
    switch (layer_it->type_layer) {
      ...
      case LAYER::FULLY_CONNECTED_RECURRENT:
        ...
        if (this->Information__Layer__Normalization(inp, layer_it) == false) {
          ERR(L"An error has been triggered from the \"Information__Layer__Normalization()\" function.", );
          return false;
        }
        ...
        if (this->Information__Layer__FC(inp, layer_it, prev_layer) == false) {
          ERR(L"An error has been triggered from the \"Information__Layer__FC()\" function.", );
          return false;
        }
        ...
        if (this->Information__Layer__AF(inp, layer_it) == false) {
          ERR(L"An error has been triggered from the \"Information__Layer__AF()\" function.", );
          return false;
        }
        // |END| AF unit(s). |END|
        ...
        if (this->Information__Layer__Bias(inp, layer_it) == false) {
          ERR(L"An error has been triggered from the \"Information__Layer__Bias()\" function.", );
          return false;
        }
      ...
      case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
        ...
        if (this->Information__Layer__AF_Ind_Recurrent(inp, layer_it) == false) {
          ERR(L"An error has been triggered from the \"Information__Layer__AF_Ind_Recurrent()\" function.", );
          return false;
        }
      ...
      case LAYER::LSTM:
        ...
        if (this->Information__Layer__LSTM(inp, layer_it, prev_layer) == false) {
          ERR(L"An error has been triggered from the \"Information__Layer__LSTM()\" function.", );
          return false;
        }
  ...
  if (this->Information__Output_Layer(inp, layer_it, prev_layer) == false) {
    ERR(L"An error has been triggered from the \"Information__Output_Layer()\" function.", );
    return false;
  }
  //  |END| Neuron_unit. |END|
...
bool Model::Information__Layer__Normalization(std::wstring &out,
  ...
  for (; unit_it != last_unit; ++unit_it) {
    ...
    if (this->Information__Normalized_Unit(n_units, layer->type_normalization, unit_it, out) == false) {
      ERR(L"An error has been triggered from the \"Information__Normalized_Unit(%zu, ref, ref)\" function.", n_units);
    }
  }
  // clang-format on
...
template <class U, LAYER::TYPE const E>
void Model::Layer__LSTM_Information__Connection(
    std::wstring &out, BlockUnit const *const block_it,
    U const *const first_inp_unit) {
  ...
  CellUnit const *const *const state_connections(
