...
template<typename T>
__global__ void kernel__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons(size_t const number_neurons_received,
...
template<typename T>
__global__ void kernel__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons(size_t const size_received,
...
template<typename T>
__global__ void kernel_while__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                                  size_t const number_neurons_received,
                                                                                                                                                                                  size_t const number_connections_received,
                                                                                                                                                                                  T *const ptr_array_derivatives_paramters_received,
                                                                                                                                                                                  T const *const ptr_array_neuron_units_errors_received,
...
template<typename T>
__global__ void kernel__cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons(size_t const number_neurons_received,
                                                                                                                                                                        size_t const number_connections_received,
                                                                                                                                                                        ...
                                                                                                                                                                        struct cuLayer *const layer_it)
{
    ...
    LAUNCH_KERNEL_POINTER_1D(cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T>,
...
template<typename T>
__global__ void kernel__cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                        size_t const number_neurons_received,
                                                                                                                                                                        size_t const number_connections_received,
                                                                                                                                                                        size_t const total_parameters_allocated_received,
                                                                                                                                                                        T *const ptr_array_derivatives_parameters_received,
...
template<typename T>
__global__ void kernel_while__cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                                size_t const number_neurons_received,
                                                                                                                                                                                size_t const number_connections_received,
                                                                                                                                                                                size_t const total_parameters_allocated_received,
                                                                                                                                                                                T *const ptr_array_derivatives_parameters_received,
                                                                                                                                                                                ...
                                                                                                                                                                                struct cuLayer *const layer_it)
{
    ...
    if(layer_it->ptr_dim3_grid_neurons->x * layer_it->ptr_dim3_block_neurons->x < number_neurons_received - 1u) // Subtract bias.
    {
        ...
        do
        {
            ...
            kernel_while__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (number_neurons_received - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                      number_neurons_received,
                                                                                                                                                                                                                                                                                                                                      number_connections_received,
                                                                                                                                                                                                                                                                                                                                      ptr_array_derivatives_parameters_received + blockIdx.x * total_parameters_allocated_received,
                                                                                                                                                                                                                                                                                                                                      tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_thread_global_index * number_neurons_received,
    ...
    else if(layer_it->ptr_dim3_grid_neurons->x * layer_it->ptr_dim3_block_neurons->x > number_neurons_received - 1u) // Subtract bias.
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T> <<< *layer_it->ptr_dim3_grid_neurons, *layer_it->ptr_dim3_block_neurons >>> (number_neurons_received - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                             number_neurons_received,
                                                                                                                                                                                                                                                                                                                             number_connections_received,
                                                                                                                                                                                                                                                                                                                             ptr_array_derivatives_parameters_received + blockIdx.x * total_parameters_allocated_received,
                                                                                                                                                                                                                                                                                                                             tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_thread_global_index * number_neurons_received,
...
template<typename T>
__global__ void kernel__cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons(size_t const number_neurons_received,
                                                                                                                                                                         size_t const number_connections_received,
                                                                                                                                                                         size_t const total_parameters_allocated_received,
                                                                                                                                                                         T *const ptr_array_derivatives_parameters_received,
                                                                                                                                                                         T const *const ptr_array_neuron_units_errors_received,
...
template<typename T>
__global__ void kernel__cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                                         size_t const number_neurons_received,
                                                                                                                                                                         size_t const number_connections_received,
                                                                                                                                                                         size_t const total_parameters_allocated_received,
                                                                                                                                                                         T *const ptr_array_derivatives_parameters_received,
...
template<typename T>
__global__ void kernel_while__cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                                                  size_t const number_neurons_received,
                                                                                                                                                                                  size_t const number_connections_received,
                                                                                                                                                                                  size_t const total_parameters_allocated_received,
                                                                                                                                                                                  T *const ptr_array_derivatives_parameters_received,
...
__device__ void cuModel::Update_Derivative_Weight__FC_to_FC(bool &ref_synchronized_received,
                                                                                                                     ...
                                                                                                                     struct dim3 const *const ptr_dim3_batch_size_block_received)
{
    ...
    if(USE_PARALLEL && batch_size >= warpSize)
    {
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons<var>,
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(cuModel__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons<var>,
                                                              ptr_dim3_batch_size_grid_received,
                                                              ptr_dim3_batch_size_block_received,
                                                              0_UZ,
                                                              batch_size,
    ...
    else if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize)
    {
        ...
        if(layer_it->ptr_dim3_grid_neurons_DP->x * layer_it->ptr_dim3_block_neurons_DP->x < tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel_while__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                                         tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                         tmp_number_connections,
                                                                                                                                                                                                                                                                                                                                                         this->ptr_array_derivatives_parameters + *tmp_ptr_layer_it_first_neuron->ptr_first_forward_connection_index,
        ...
        else if(layer_it->ptr_dim3_grid_neurons_DP->x * layer_it->ptr_dim3_block_neurons_DP->x > tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                                tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                tmp_number_connections,
                                                                                                                                                                                                                                                                                                                                                this->ptr_array_derivatives_parameters + *tmp_ptr_layer_it_first_neuron->ptr_first_forward_connection_index,
                                                                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_data_index * tmp_number_neuron_units,
        ...
        else
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__cuModel__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<var> <<< *layer_it->ptr_dim3_grid_neurons_DP, *layer_it->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                tmp_number_connections,
                                                                                                                                                                                                                                                                                                                                                this->ptr_array_derivatives_parameters + *tmp_ptr_layer_it_first_neuron->ptr_first_forward_connection_index,
                                                                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_data_index * tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                tmp_ptr_previous_layer_first_neuron->ptr_array_values + tmp_data_index * (tmp_number_connections + 1u), // Add bias.
