                                                                                                                     ...
                                                                                                                     var *const ptr_array_output_normalizes_received)
{
    ...
    for(tmp_input_index__int = 0; tmp_input_index__int < tmp_units_size__int; ++tmp_input_index__int)
    {
        ...
        *tmp_ptr_array_variance = sqrt(*tmp_ptr_array_variance * tmp_batch_scale - *tmp_ptr_array_mean * *tmp_ptr_array_mean + tmp_epsilon);
                                                                                                                         ...
                                                                                                                         var *const ptr_array_output_normalizes_received)
{
    ...
    for(tmp_input_index__int = 0; tmp_input_index__int < tmp_units_size__int; ++tmp_input_index__int)
    {
        ...
        *tmp_ptr_array_variance = sqrt(*tmp_ptr_array_variance * tmp_batch_scale - *tmp_ptr_array_mean * *tmp_ptr_array_mean + tmp_epsilon);
        ...
        ptr_array_r_corrections_received[tmp_input_timed_index + static_cast<size_t>(tmp_input_index__int)] = Math::clip<var>(tmp_gamma, tmp_r_correction, tmp_r_correction_maximum);
        ...
        ptr_array_d_corrections_received[tmp_input_timed_index + static_cast<size_t>(tmp_input_index__int)] = Math::clip<var>(tmp_d_correction, -tmp_d_correction_maximum, tmp_d_correction_maximum);
    }
                                                                                                  ...
                                                                                                  var *const ptr_array_outputs_received)
{
    ...
    for(tmp_example_index__int = 0; tmp_example_index__int < tmp_batch_size__int; ++tmp_example_index__int)
    {
        ...
        for(tmp_input_index = 0_UZ; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_layer_maximum_summation = std::max(tmp_layer_maximum_summation, tmp_ptr_array_inputs[tmp_input_index]); }
