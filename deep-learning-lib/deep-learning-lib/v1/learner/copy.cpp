                                        ...
                                        size_t const allowable_memory)
{
       ...
       ref_source_Neural_Network_received.is_update_from_device == false)
    {
        ...
        {
            ERR(L"An error has been triggered from the \"Copy__Parameters__Device_To_Host()\" function.",);
        ...
        {
            ERR(L"An error has been triggered from the \"Copy__Batch_Normalization_Neurons__Device_To_Host()\" function.",);
    ...
    */
    ...
    if(this->Allocate__Structure(ref_source_Neural_Network_received.total_layers, allowable_memory != 0_UZ ? allowable_memory : ref_source_Neural_Network_received.maximum_allowable_memory_bytes) == false)
    {
        ERR(L"An error has been triggered from the \"Allocate__Structure(%zu, %zu)\" function.",
                                 ...
                                 allowable_memory != 0_UZ ? allowable_memory : ref_source_Neural_Network_received.maximum_allowable_memory_bytes);
    ...
    *this->ptr_array_loss_values = *ref_source_Neural_Network_received.ptr_array_loss_values;
    ...
    this->ptr_array_accuracy_values[0][0] = ref_source_Neural_Network_received.ptr_array_accuracy_values[0][0];
    this->ptr_array_accuracy_values[1][0] = ref_source_Neural_Network_received.ptr_array_accuracy_values[1][0];
    this->ptr_array_accuracy_values[2][0] = ref_source_Neural_Network_received.ptr_array_accuracy_values[2][0];
    this->ptr_array_accuracy_values[3][0] = ref_source_Neural_Network_received.ptr_array_accuracy_values[3][0];
    this->ptr_array_accuracy_values[4][0] = ref_source_Neural_Network_received.ptr_array_accuracy_values[4][0];
                                                                                                                                                                                  ...
                                                                                                                                                                                  ++tmp_ptr_source_layer_it)
    {
        ...
        // Pooling.
        tmp_ptr_destination_layer_it->pooling_values[0] = tmp_ptr_source_layer_it->pooling_values[0];
        tmp_ptr_destination_layer_it->pooling_values[1] = tmp_ptr_source_layer_it->pooling_values[1];
        tmp_ptr_destination_layer_it->pooling_values[2] = tmp_ptr_source_layer_it->pooling_values[2];
        tmp_ptr_destination_layer_it->pooling_values[3] = tmp_ptr_source_layer_it->pooling_values[3];
        tmp_ptr_destination_layer_it->pooling_values[4] = tmp_ptr_source_layer_it->pooling_values[4];
        // |END Pooling. |END|
                                                                                                                                                                                        ...
                                                                                                                                                                                        ++tmp_ptr_source_layer_it)
    {
        ...
        if(tmp_ptr_destination_layer_it->type_layer == LAYER::AVERAGE_POOLING
          ...
          ||
          tmp_ptr_destination_layer_it->type_layer == LAYER::RESIDUAL) { continue; }
        
        tmp_ptr_destination_previous_layer_it = tmp_ptr_destination_layer_it->previous_connected_layers[0];

        if(tmp_ptr_destination_layer_it->type_layer == LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT)
        {
            this->Copy__Layer__AF_Ind_Recurrent(tmp_ptr_source_layer_it,
                                                                      ref_source_Neural_Network_received.ptr_array_AF_Ind_recurrent_units,
                                                                      this->ptr_array_AF_Ind_recurrent_units,
                                                                      reinterpret_cast<AF_Ind_recurrent_unit**>(ref_source_Neural_Network_received.ptr_array_ptr_connections),
                                                                      reinterpret_cast<AF_Ind_recurrent_unit**>(this->ptr_array_ptr_connections));
        }
        ...
        switch(tmp_ptr_destination_previous_layer_it->type_layer)
        {
            ...
            case LAYER::RESIDUAL:
                switch(tmp_ptr_destination_layer_it->type_layer)
                {
                    ...
                    case LAYER::FULLY_CONNECTED_RECURRENT:
                        this->Copy__Layer__FC<Basic_unit>(tmp_ptr_source_layer_it,
                                                                                         tmp_ptr_destination_layer_it,
                                                                                         ref_source_Neural_Network_received.ptr_array_basic_units,
                                                                                         this->ptr_array_basic_units,
                                                                                         reinterpret_cast<Basic_unit**>(ref_source_Neural_Network_received.ptr_array_ptr_connections),
                                                                                         reinterpret_cast<Basic_unit**>(this->ptr_array_ptr_connections));
                            break;
                    case LAYER::LSTM:
                        this->Copy__Layer__LSTM<Basic_unit>(tmp_ptr_source_layer_it,
                                                                                            tmp_ptr_destination_layer_it,
            ...
            case LAYER::FULLY_CONNECTED_RECURRENT:
                switch(tmp_ptr_destination_layer_it->type_layer)
                {
                    ...
                    case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                    case LAYER::FULLY_CONNECTED_RECURRENT:
                        this->Copy__Layer__FC<Neuron_unit>(tmp_ptr_source_layer_it,
                                                                                           tmp_ptr_destination_layer_it,
                                                                                           ref_source_Neural_Network_received.ptr_array_neuron_units,
                                                                                           this->ptr_array_neuron_units,
                                                                                           reinterpret_cast<Neuron_unit**>(ref_source_Neural_Network_received.ptr_array_ptr_connections),
                                                                                           reinterpret_cast<Neuron_unit**>(this->ptr_array_ptr_connections));
                            break;
                    case LAYER::LSTM:
                        this->Copy__Layer__LSTM<Neuron_unit>(tmp_ptr_source_layer_it,
                                                                                        tmp_ptr_destination_layer_it,
                                                                                        ref_source_Neural_Network_received.ptr_array_cell_units,
                                                                                        ref_source_Neural_Network_received.ptr_array_neuron_units,
                                                                                        this->ptr_array_neuron_units,
            ...
            case LAYER::LSTM:
                switch(tmp_ptr_destination_layer_it->type_layer)
                {
                    ...
                    case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                    case LAYER::FULLY_CONNECTED_RECURRENT:
                        this->Copy__Layer__FC<CellUnit>(tmp_ptr_source_layer_it,
                                                                                      tmp_ptr_destination_layer_it,
                                                                                      ref_source_Neural_Network_received.ptr_array_cell_units,
                                                                                      this->ptr_array_cell_units,
                                                                                      reinterpret_cast<CellUnit**>(ref_source_Neural_Network_received.ptr_array_ptr_connections),
                                                                                      reinterpret_cast<CellUnit**>(this->ptr_array_ptr_connections));
                            break;
                    case LAYER::LSTM:
                        this->Copy__Layer__LSTM<CellUnit>(tmp_ptr_source_layer_it,
                                                                                          tmp_ptr_destination_layer_it,
                                                                                          ref_source_Neural_Network_received.ptr_array_cell_units,
                                                                                          ref_source_Neural_Network_received.ptr_array_cell_units,
                                                                                          this->ptr_array_cell_units,
            ...
            case LAYER::MAX_POOLING:
                switch(tmp_ptr_destination_layer_it->type_layer)
                {
                    ...
                    case LAYER::FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                    case LAYER::FULLY_CONNECTED_RECURRENT:
                        this->Copy__Layer__FC<Basic_indice_unit>(tmp_ptr_source_layer_it,
                                                                                                   tmp_ptr_destination_layer_it,
                                                                                                   ref_source_Neural_Network_received.ptr_array_basic_indice_units,
                                                                                                   this->ptr_array_basic_indice_units,
                                                                                                   reinterpret_cast<Basic_indice_unit**>(ref_source_Neural_Network_received.ptr_array_ptr_connections),
                                                                                                   reinterpret_cast<Basic_indice_unit**>(this->ptr_array_ptr_connections));
                            break;
                    case LAYER::LSTM:
                        this->Copy__Layer__LSTM<Basic_indice_unit>(tmp_ptr_source_layer_it,
                                                                                                       tmp_ptr_destination_layer_it,
                                                                                                       ref_source_Neural_Network_received.ptr_array_cell_units,
                                                                                                       ref_source_Neural_Network_received.ptr_array_basic_indice_units,
                                                                                                       this->ptr_array_basic_indice_units,
            ...
            default:
                ERR(L"Layer type (%d | %ls) is not managed in",
                                         ...
                                         LAYER_NAME[tmp_ptr_destination_previous_layer_it->type_layer].c_str());
                    return false;
        }
    }
    ...
    this->Copy__Normalized_Units(0_UZ,
    ...
    {
        ERR(L"An error has been triggered from the \"Copy__Optimizer_Parameters(ref, %ls)\" function.",
...
#ifdef COMPILE_CUDA
        this->set_cu(ref_source_Neural_Network_received.use_cu, ref_source_Neural_Network_received.is_cu_initialized ? ref_source_Neural_Network_received.cumodel->Get__Maximum_Allowable_Memory() : 0_UZ);
#endif
    }
    else
    {
                                           ...
                                           bool const update_delta_optimizer_received)
{
                                               ...
                                               tmp_update_delta_optimizer = update_delta_optimizer_received]() -> bool
    {
        ...
        {
            ERR(L"An error has been triggered from the \"copy(ref, %ls, %ls)\" function.",
    ...
    */
    ...
    if(this->Set__Maximum_Thread_Usage(ref_source_Neural_Network_received.pct_threads) == false)
    {
    ...
    else if(this->set_max_batch_size(ref_source_Neural_Network_received.maximum_batch_size) == false)
    {
...
bool Model::Copy__Optimizer_Parameters(Model const *const model, bool const copy_delta_optimizer_received)
{
    switch(this->type_optimizer_function)
    {
        case OPTIMIZER::GD: this->Copy__Gradient_Descent_Parameters(model); break;
        case OPTIMIZER::IRPROP_MINUS: this->Copy__RPROP_minus_Parameters(model); break;
        case OPTIMIZER::IRPROP_PLUS: this->Copy__RPROP_plus_Parameters(model); break;
        case OPTIMIZER::SARPROP: this->Copy__SARProp_Parameters(model); break;
        case OPTIMIZER::QUICKPROP: this->Copy__QuickProp_Parameters(model); break;
        case OPTIMIZER::ADAM:
        case OPTIMIZER::ADAMAX:
        case OPTIMIZER::AMSGRAD: this->Copy__Adam_Parameters(model); break;
        case OPTIMIZER::NOSADAM: this->Copy__NosAdam_Parameters(model); break;
        case OPTIMIZER::ADABOUND:
        case OPTIMIZER::AMSBOUND: this->Copy__AdaBound_Parameters(model); break;
        default:
    ...
    if(copy_delta_optimizer_received)
    {
        switch(this->type_optimizer_function)
        {
            case OPTIMIZER::GD:
                ...
                {
                    ERR(L"An error has been triggered from the \"Copy__Delta__Gradient_Descent(ptr)\" function.",);
            ...
            case OPTIMIZER::IRPROP_MINUS:
                ...
                {
                    ERR(L"An error has been triggered from the \"Copy__Delta__iRPROP_minus(ptr)\" function.",);
            ...
            case OPTIMIZER::IRPROP_PLUS:
                ...
                {
                    ERR(L"An error has been triggered from the \"Copy__Delta__iRPROP_plus(ptr)\" function.",);
            ...
            case OPTIMIZER::NOSADAM:
                ...
                {
                    ERR(L"An error has been triggered from the \"Copy__Delta__Adam(ptr)\" function.",);
            ...
            case OPTIMIZER::AMSBOUND:
                ...
                {
                    ERR(L"An error has been triggered from the \"Copy__Delta__AMSGrad(ptr)\" function.",);
...
{
    if(this->learning_momentum == 0_r) { return true; }
    else if(model->ptr_array_previous_delta_parameters == nullptr)
    {
        ERR(L"Source array \"ptr_array_previous_delta_parameters\" is a nullptr.",);

        return false;
    }
    else if(this->ptr_array_previous_delta_parameters == nullptr)
    {
        ERR(L"Destination array \"ptr_array_previous_delta_parameters\" is a nullptr.",);
...
bool Model::Copy__Delta__iRPROP_minus(Model const *const model)
{
    ...
    else
    {
        memcpy(this->ptr_array_previous_steps,
                     model->ptr_array_previous_steps,
                     this->total_parameters * sizeof(real));
    }
    
    if(model->ptr_array_previous_derivatives_parameters == nullptr)
    {
        ERR(L"Source array \"ptr_array_previous_derivatives_parameters\" is a nullptr.",);

        return false;
    }
    else if(this->ptr_array_previous_derivatives_parameters == nullptr)
    {
        ERR(L"Destination array \"ptr_array_previous_derivatives_parameters\" is a nullptr.",);
...
bool Model::Copy__Delta__iRPROP_plus(Model const *const model)
{
    if(this->Copy__Delta__iRPROP_minus(model) == false)
    {
        ERR(L"An error has been triggered from the \"Copy__Delta__iRPROP_minus()\" function.",);
...
bool Model::Copy__Delta__Adam(Model const *const model)
{
    ...
    {
        ERR(L"Source array \"ptr_array_previous_biased_first_moment\" is a nullptr.",);

        return false;
    }
    else if(this->ptr_array_previous_biased_first_moment == nullptr)
    {
        ERR(L"Destination array \"ptr_array_previous_biased_first_moment\" is a nullptr.",);
    ...
    {
        ERR(L"Source array \"ptr_array_previous_biased_second_moment\" is a nullptr.",);

        return false;
    }
    else if(this->ptr_array_previous_biased_second_moment == nullptr)
    {
        ERR(L"Destination array \"ptr_array_previous_biased_second_moment\" is a nullptr.",);
...
bool Model::Copy__Delta__AMSGrad(Model const *const model)
{
    if(this->Copy__Delta__Adam(model) == false)
    {
        ERR(L"An error has been triggered from the \"Copy__Delta__Adam()\" function.",);
    ...
    {
        ERR(L"Source array \"ptr_array_previous_biased_second_moment_hat\" is a nullptr.",);

        return false;
    }
    else if(this->ptr_array_previous_biased_second_moment_hat == nullptr)
    {
        ERR(L"Destination array \"ptr_array_previous_biased_second_moment_hat\" is a nullptr.",);
...
void Model::Copy__Training_Parameters(Model const *const model)
{
    ...
    {
        ERR(L"An error has been triggered from the \"set_clip_gradient(%f)\" function.",
                                 model->clip_gradient);
    }
    else if(this->Set__Pre_Training_Level(model->pre_training_level) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Pre_Training_Level(%zu)\" function.",
...
void Model::Copy__Initializer__Weight_Parameter(Model const &ref_source_Neural_Network_received)
{
...
{
    // Regularization parameters.
    if(this->Set__Regularization__Max_Norm_Constraints(model->regularization__max_norm_constraints) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Regularization__Max_Norm_Constraints(%f)\" function.",
                                 model->regularization__max_norm_constraints);

        return;
    }
    else if(this->Set__Regularization__L1(model->regularization__l1) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Regularization__L1(%f)\" function.",
                                 model->regularization__l1);

        return;
    }
    else if(this->Set__Regularization__L2(model->regularization__l2) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Regularization__L2(%f)\" function.",
                                 model->regularization__l2);

        return;
    }
    else if(this->Set__Regularization__SRIP(model->regularization__srip) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Regularization__SRIP(%f)\" function.",
                                 model->regularization__srip);

        return;
    }
    else if(this->Set__Regularization__Weight_Decay(model->weight_decay) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Regularization__Weight_Decay(%f)\" function.",
                                 model->weight_decay);
                                                             ...
                                                             Layer *ptr_array_destination_layers_received)
{
                                                                                                              ...
                                                                                                              ++ptr_array_destination_layers_received)
    {
        ...
        {
            ERR(L"An error has been triggered from the \"Set__Tied_Parameter(ptr, %ls)\" function.",
                                     ptr_array_source_layers_received->use_tied_parameter ? "true" : "false");
        }
    }
}

void Model::Copy__Sparse_K_Filters(Layer const *ptr_array_source_layers_received,
                                                                    Layer const *const ptr_last_source_layer_received,
                                                                    Layer *ptr_array_destination_layers_received)
{
    for(; ptr_array_source_layers_received != ptr_last_source_layer_received; ++ptr_array_source_layers_received,
                                                                                                              ++ptr_array_destination_layers_received)
    {
        ...
        {
            ERR(L"An error has been triggered from the \"Set__Alpha_Sparsity(%f)\" function.",
...
void Model::Copy__Constraint_Recurrent_Weight(Layer const *ptr_array_source_layers_received,
                                                                                      Layer const *const ptr_last_source_layer_received,
                                                                                      Layer *ptr_array_destination_layers_received)
{
    for(; ptr_array_source_layers_received != ptr_last_source_layer_received; ++ptr_array_source_layers_received,
                                                                                                              ++ptr_array_destination_layers_received)
    {
                                                                                               ...
                                                                                               ptr_array_source_layers_received->constraint_recurrent_weight_upper_bound) == false)
        {
            ERR(L"An error has been triggered from the \"Set__Regularization__Constraint_Recurrent_Weight(ptr, %f, %f)\" function.",
                                     ptr_array_source_layers_received->constraint_recurrent_weight_lower_bound,
                                     ptr_array_source_layers_received->constraint_recurrent_weight_upper_bound);
...
void Model::Copy__Dropout(Layer const *ptr_array_source_layers_received,
    ...
    for(; ptr_array_source_layers_received != ptr_last_source_layer_received; ++ptr_array_source_layers_received,
                                                                                                              ++ptr_array_destination_layers_received) {
#ifdef COMPILE_CUDA
        if(ptr_array_source_layers_received->dropout_values[0] != ptr_array_destination_layers_received->dropout_values[0]
          ||
        ...
        if(this->set_dropout(ptr_array_destination_layers_received,
                                        ...
                                        false) == false)
        {
            ERR(L"An error has been triggered from the \"Set__Layer_Normalization(ptr, %ls, %f, %f, %f, false)\" function.",
                                     LAYER_DROPOUT_NAME[ptr_array_source_layers_received->type_dropout].c_str(),
...
void Model::Copy__Normalization(Model const *const ptr_source_Neural_Network_received)
{
    if(this->Set__Normalization_Momentum_Average(ptr_source_Neural_Network_received->normalization_momentum_average) == false)
    {
        ERR(L"An error has been triggered from the \"Set__Normalization_Momentum_Average(%f)\" function.",
    ...
    {
        ERR(L"An error has been triggered from the \"Set__Normalization_Epsilon(%f)\" function.",
    ...
    {
        ERR(L"An error has been triggered from the \"Set__Batch_Renormalization_r_Correction_Maximum(%f)\" function.",
                                 ptr_source_Neural_Network_received->batch_renormalization_r_correction_maximum);
    ...
    {
        ERR(L"An error has been triggered from the \"Set__Batch_Renormalization_d_Correction_Maximum(%f)\" function.",
                                 ptr_source_Neural_Network_received->batch_renormalization_d_correction_maximum);

        return;
    }
}

void Model::Copy__Normalization(Layer const *ptr_array_source_layers_received,
                                                               Layer const *const ptr_last_source_layer_received,
                                                               Layer *ptr_array_destination_layers_received) {
#ifdef COMPILE_CUDA
    bool tmp_parameters_has_change(false);
    ...
    for(; ptr_array_source_layers_received != ptr_last_source_layer_received; ++ptr_array_source_layers_received,
        ...
        {
            ERR(L"An error has been triggered from the \"Set__Layer_Normalization(ptr, %ls)\" function.",
                                     LAYER_NORM_NAME[ptr_array_source_layers_received->type_normalization].c_str());
...
#ifdef COMPILE_CUDA
    if(this->is_cu_initialized && (tmp_parameters_has_change || this->Use__Normalization()))
    { this->cumodel->Copy__Normalization(this); }
#endif
}

void Model::Copy__Block(BlockUnit const *const ptr_source_block_unit_received, BlockUnit *const ptr_destination_block_unit_received)
{
...
void Model::Copy__Block__AF(BlockUnit const *const ptr_source_block_unit_received, BlockUnit *const ptr_destination_block_unit_received)
{
...
{
    if(start_index_received + end_index_received == 0_UZ) { return; }
    ...
    BlockUnit *tmp_ptr_destination_block_it(this->ptr_array_block_units + start_index_received);
    ...
    {
        BlockUnit const *const tmp_ptr_destination_last_block_unit(tmp_ptr_destination_block_it + (end_index_received - start_index_received));
...
void Model::Copy__Blocks__AF(size_t const start_index_received,
                                                             size_t const end_index_received,
                                                             BlockUnit const *ptr_array_source_block_units_received)
{
    if(start_index_received + end_index_received == 0_UZ) { return; }
...
void Model::Copy__Neuron_Units(size_t const start_index_received,
                                                               size_t const end_index_received,
                                                               Neuron_unit const *ptr_array_source_neuron_units_received)
{
    ...
    Neuron_unit *tmp_ptr_destination_neuron_it(this->ptr_array_neuron_units + start_index_received);
    ...
    {
        Neuron_unit const *const tmp_ptr_destination_last_neuron(tmp_ptr_destination_neuron_it + (end_index_received - start_index_received));
...
void Model::Copy__Neuron_Unit(Neuron_unit const *const ptr_source_neuron_unit_received, Neuron_unit *const ptr_destination_neuron_unit_received)
{
                                                         ...
                                                         AF_unit const *ptr_array_source_AF_units_received)
{
    ...
    AF_unit *tmp_ptr_destination_AF_it(this->ptr_array_AF_units + start_index_received);
    ...
    {
        AF_unit const *const tmp_ptr_destination_last_af(tmp_ptr_destination_AF_it + (end_index_received - start_index_received));
...
void Model::Copy__AF_Unit(AF_unit const *const ptr_source_AF_unit_received, AF_unit *const ptr_destination_AF_unit_received)
{
    *ptr_destination_AF_unit_received->ptr_type_activation_function = *ptr_source_AF_unit_received->ptr_type_activation_function;
}

void Model::Copy__AF_Ind_Recurrent_Units(size_t const start_index_received,
                                                                               size_t const end_index_received,
                                                                               AF_Ind_recurrent_unit const *ptr_array_source_AF_Ind_recurrent_units_received,
                                                                               bool const copy_connections_received)
{
    if(start_index_received + end_index_received == 0_UZ) { return; }
    else if(start_index_received > end_index_received)
    ...
    AF_Ind_recurrent_unit *tmp_ptr_destination_AF_Ind_it(this->ptr_array_AF_Ind_recurrent_units + start_index_received);
    ...
    {
        AF_Ind_recurrent_unit const *const tmp_ptr_destination_last_AF_ind(tmp_ptr_destination_AF_Ind_it + (end_index_received - start_index_received));
...
void Model::Copy__AF_Ind_Recurrent_Unit(AF_Ind_recurrent_unit const *const ptr_source_AF_Ind_recurrent_unit_received,
...
void Model::Copy__Normalized_Units(size_t const start_index_received,
                                                                     size_t const end_index_received,
                                                                     union Normalized_unit const *ptr_array_source_normalized_units_received)
{
    ...
    if(this->Use__Normalization())
    {
        ...
        {
            if(static_cast<size_t>(layer_it->ptr_array_normalized_units - this->ptr_array_normalized_units) < start_index_received) { continue; }
            else if(static_cast<size_t>(layer_it->ptr_array_normalized_units - this->ptr_array_normalized_units) >= end_index_received) { break; }

            if((tmp_number_units[0] = static_cast<size_t>(layer_it->ptr_last_normalized_unit - layer_it->ptr_array_normalized_units)) != 0_UZ)
            {
                    ...
                    case LAYER::RESIDUAL:
                        switch(layer_it->type_normalization)
                        {
                            ...
                            case LAYER_NORM::GHOST_BATCH_NORMALIZATION:
                                for(tmp_ptr_destination_last_normalized_unit = this->ptr_array_normalized_units + std::min<size_t>(static_cast<size_t>(layer_it->ptr_last_normalized_unit - this->ptr_array_normalized_units), end_index_received),
                                    tmp_ptr_destination_normalized_unit_it = layer_it->ptr_array_normalized_units; tmp_ptr_destination_normalized_unit_it < tmp_ptr_destination_last_normalized_unit; ++tmp_ptr_destination_normalized_unit_it,
                                                                                                                                                                                                                                                                                              ++ptr_array_source_normalized_units_received)
                                {
                                    this->Copy__Normalized_Batch_Unit(tmp_number_units[0],
                                    ...
                                    break;
                            default: ptr_array_source_normalized_units_received += tmp_number_units[0]; break;
                        }
                            break;
                    case LAYER::LSTM:
                        switch(layer_it->type_normalization)
                            ...
                            case LAYER_NORM::GHOST_BATCH_NORMALIZATION:
                                    ...
                                    tmp_ptr_block_unit_it = layer_it->ptr_array_block_units; tmp_ptr_block_unit_it != tmp_ptr_last_block_unit; ++tmp_ptr_block_unit_it)
                                {
                                        ...
                                        tmp_ptr_cell_unit_it = tmp_ptr_block_unit_it->ptr_array_cell_units; tmp_ptr_cell_unit_it != tmp_ptr_last_cell_unit; ++tmp_ptr_cell_unit_it)
                                    {
                                        ...
                                        for(tmp_ptr_destination_last_normalized_unit = this->ptr_array_normalized_units + std::min<size_t>(static_cast<size_t>(tmp_ptr_cell_unit_it->ptr_last_normalized_unit - this->ptr_array_normalized_units), end_index_received),
                                            tmp_ptr_destination_normalized_unit_it = tmp_ptr_cell_unit_it->ptr_array_normalized_units; tmp_ptr_destination_normalized_unit_it < tmp_ptr_destination_last_normalized_unit; ++tmp_ptr_destination_normalized_unit_it,
                                                                                                                                                                                                                                                                                                           ++ptr_array_source_normalized_units_received)
                                        {
                                            this->Copy__Normalized_Batch_Unit(tmp_number_units[1],
                                                                                                  ptr_array_source_normalized_units_received->normalized_batch_units,
                                                                                                  tmp_ptr_destination_normalized_unit_it->normalized_batch_units);
                                        }
                                    }
                                    ...
                                    for(tmp_ptr_destination_last_normalized_unit = this->ptr_array_normalized_units + std::min<size_t>(static_cast<size_t>(tmp_ptr_block_unit_it->ptr_last_normalized_unit - this->ptr_array_normalized_units), end_index_received),
                                    ...
                                    break;
                            default: ptr_array_source_normalized_units_received += 6_UZ * static_cast<size_t>(layer_it->ptr_last_block_unit - layer_it->ptr_array_block_units) + 3_UZ * static_cast<size_t>(layer_it->ptr_last_cell_unit - layer_it->ptr_array_cell_units); break;
                        }
                            break;
                    default:
                        ERR(L"Layer type (%d | %ls) is not managed in",
...
void Model::Copy__Normalized_Batch_Unit(size_t const number_units_received,
...
template<class U> void Model::Copy__Layer__FC(Layer const *const ptr_source_layer_received,
...
{
    Neuron_unit const *const tmp_ptr_source_last_neuron_unit(ptr_source_layer_received->ptr_last_neuron_unit),
                                        *tmp_ptr_source_neuron_unit_it(ptr_source_layer_received->ptr_array_neuron_units);
    Neuron_unit *tmp_ptr_destination_neuron_unit_it(ptr_destination_layer_received->ptr_array_neuron_units);
                                                                                                              ...
                                                                                                              ++tmp_ptr_destination_neuron_unit_it)
    {
        ...
        for(tmp_connection_index = 0_UZ; tmp_connection_index != tmp_number_forward_connections; ++tmp_connection_index)
...
void Model::Copy__Layer__AF_Ind_Recurrent(Layer const *const ptr_source_layer_received,
                                                                          AF_Ind_recurrent_unit *const ptr_source_first_AF_Ind_recurrent_unit_received,
                                                                          AF_Ind_recurrent_unit *const ptr_destination_first_AF_Ind_recurrent_unit_received,
...
{
    AF_Ind_recurrent_unit const *const tmp_ptr_source_last_AF_Ind_recurrent_unit(ptr_source_layer_received->ptr_last_AF_Ind_recurrent_unit),
...
template<class U> void Model::Copy__Layer__LSTM(Layer const *const ptr_source_layer_received,
                                                                                                  Layer *const ptr_destination_layer_received,
...
{
    BlockUnit const *const tmp_ptr_source_last_block_unit(ptr_source_layer_received->ptr_last_block_unit),
                                       *tmp_ptr_source_block_unit_it(ptr_source_layer_received->ptr_array_block_units);
    BlockUnit *tmp_ptr_destination_block_unit_it(ptr_destination_layer_received->ptr_array_block_units);
                                                                                                          ...
                                                                                                          ++tmp_ptr_destination_block_unit_it)
    {
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    ++tmp_ptr_destination_block_ptr_cell_unit_it)
        {
            ...
            tmp_ptr_source_cell_input_array_ptr_connection_cell_units = reinterpret_cast<CellUnit *const *>(ptr_source_array_ptr_connections_received + tmp_ptr_source_block_ptr_cell_unit_it->first_index_recurrent_connection_cell_input);
            
            tmp_ptr_destination_cell_input_array_ptr_connection_cell_units = reinterpret_cast<CellUnit **>(ptr_destination_array_ptr_connections_received + tmp_ptr_destination_block_ptr_cell_unit_it->first_index_recurrent_connection_cell_input);
        ...
        // [0] Recurrent, gates.
        tmp_ptr_source_input_gate_array_ptr_connection_cell_units = reinterpret_cast<CellUnit *const *>(ptr_source_array_ptr_connections_received + tmp_ptr_source_block_unit_it->first_index_recurrent_connection_input_gate);
        tmp_ptr_source_forget_gate_array_ptr_connection_cell_units = reinterpret_cast<CellUnit *const *>(ptr_source_array_ptr_connections_received + tmp_ptr_source_block_unit_it->first_index_recurrent_connection_forget_gate);
        tmp_ptr_source_output_gate_array_ptr_connection_cell_units = reinterpret_cast<CellUnit *const *>(ptr_source_array_ptr_connections_received + tmp_ptr_source_block_unit_it->first_index_recurrent_connection_output_gate);
        
        tmp_ptr_destination_input_gate_array_ptr_connection_cell_units = reinterpret_cast<CellUnit **>(ptr_destination_array_ptr_connections_received + tmp_ptr_destination_block_unit_it->first_index_recurrent_connection_input_gate);
        tmp_ptr_destination_forget_gate_array_ptr_connection_cell_units = reinterpret_cast<CellUnit **>(ptr_destination_array_ptr_connections_received + tmp_ptr_destination_block_unit_it->first_index_recurrent_connection_forget_gate);
        tmp_ptr_destination_output_gate_array_ptr_connection_cell_units = reinterpret_cast<CellUnit **>(ptr_destination_array_ptr_connections_received + tmp_ptr_destination_block_unit_it->first_index_recurrent_connection_output_gate);
    ...
    #ifndef NO_PEEPHOLE
        //    [1] Peepholes.
        tmp_ptr_source_array_ptr_connection_cell_units = reinterpret_cast<CellUnit *const *>(ptr_source_array_ptr_connections_received);
        
        tmp_ptr_destination_array_ptr_connection_cell_units = reinterpret_cast<CellUnit **>(ptr_destination_array_ptr_connections_received);
