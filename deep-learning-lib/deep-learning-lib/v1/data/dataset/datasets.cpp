...
#include "deep-learning-lib/io/term/keyboard.hpp"
...
bool Datasets::user_controls(void) {
  while (true) {
    ...
    INFO(
        L"[4]: Desired optimization time between reports (%f "
        "seconds).",
        this->_desired_optimization_time_between_reports);
    ...
    switch (parse_discrete<int>(0, 8, L"Option: ")) {
      ...
      case 1:
        if (this->User_Controls__Type_Evaluation() == false) {
          ERR(L"An error has been triggered from the "
              "\"User_Controls__Type_Evaluation()\" function.", );
      ...
      case 2:
        if (this->User_Controls__Type_Metric() == false) {
          ERR(L"An error has been triggered from the "
              "\"User_Controls__Type_Metric()\" function.", );
      ...
      case 3:
        if (this->User_Controls__Set__Maximum_Data() == false) {
          ERR(L"An error has been triggered from the "
              "\"User_Controls__Set__Maximum_Data()\" function.", );
      ...
      case 7:
        if (this->HyperOpt::user_controls() == false) {
          ERR(L"An error has been triggered from the "
              "\"HyperOpt::user_controls()\" function.", );
      ...
      default:
        ERR(L"An error has been triggered from the "
            "\"parse_discrete<int>(%u, %u)\" function.",
            0, 8u);
        break;
    }
  }
...
bool Datasets::User_Controls__Set__Maximum_Data(void) {
  ...
  if (this->Set__Maximum_Data(parse_discrete<size_t>(
          1_UZ, this->p_n_data, L"Maximum example(s): ")) == false) {
    ERR(L"An error has been triggered from the "
        "\"Set__Maximum_Data()\" function.", );
...
bool Datasets::User_Controls__Type_Evaluation(void) {
  ...
  this->set_eval_env(static_cast<ENV::TYPE>(
      parse_discrete<int>(1, ENV::LENGTH - 1, L"Type: ")));
  ...
  switch (this->get_dataset(ENV::TRAIN)->Get__Type_Dataset_Process()) {
    case DATASET::BATCH:
      if (this->User_Controls__Optimization_Processing_Parameters__Batch() ==
          false) {
        ERR(L"An error has been triggered from the "
            "\"User_Controls__Optimization_Processing_Parameters__Batch()\" "
            "function.", );
    ...
    case DATASET::MINIBATCH:
      if (this->User_Controls__Optimization_Processing_Parameters__Mini_Batch() ==
          false) {
        ERR(L"An error has been triggered from the "
            "\"User_Controls__Optimization_Processing_Parameters__Mini_Batch()"
            "\" function.", );
    ...
    case DATASET::CROSS_VAL:
      if (this->User_Controls__Optimization_Processing_Parameters__Cross_Validation() ==
          false) {
        ERR(L"An error has been triggered from the "
            "\"User_Controls__Optimization_Processing_Parameters__Cross_"
            "Validation()\" function.", );
    ...
    case DATASET::CROSS_VAL_OPT:
      if (this->User_Controls__Optimization_Processing_Parameters__Cross_Validation__Gaussian_Search() ==
        ...
        ERR(L"An error has been triggered from the "
            "\"User_Controls__Optimization_Processing_Parameters__Cross_"
            "Validation__Gaussian_Search()\" function.", );

        return false;
      }
      break;
    default:
      ERR(L"DatasetV1 process type (%d | %ls) is not managed in the "
          "switch.",
...
bool Datasets::User_Controls__Optimization_Processing_Parameters__Batch(void) {
  while (true) {
    ...
    switch (parse_discrete<int>(0, 0, L"Option: ")) {
      case 0:
        return true;
      default:
        ERR(L"An error has been triggered from the "
...
bool Datasets::User_Controls__Optimization_Processing_Parameters__Mini_Batch(
  ...
  while (true) {
    ...
    switch (parse_discrete<int>(0, 2, L"Option: ")) {
      case 0:
        ...
        if (tmp_ptr_Dataset_Mini_Batch->Set__Desired_Data_Per_Batch(
          ...
          ERR(L"An error has been triggered from the "
              "\"Set__Desired_Data_Per_Batch()\" function.", );
  ...
  while (true) {
    ...
    switch (parse_discrete<int>(0, 2, L"Option: ")) {
      case 0:
        ...
        tmp_number_k_folds = parse_discrete<size_t>(
        ...
        tmp_number_k_sub_folds = parse_discrete<size_t>(
...
bool Datasets::
  ...
  while (true) {
    ...
    switch (parse_discrete<int>(0, 3, L"Option: ")) {
      case 0:
        // K-fold.
        INFO(L"K-fold:");
        INFO(L"Range[2, %zu].",
      ...
      case 2:
        if (tmp_ptr_Dataset_Cross_Validation_Hyperparameter_Optimization
                ->user_controls() == false) {
          ERR(L"An error has been triggered from the "
              "\"User_Controls__Push_Back()\" function.", );
...
bool Datasets::User_Controls__Optimization(Model *&trainer, Model *&trained) {
  while (true) {
    ...
    switch (parse_discrete<int>(0, 4, L"Option: ")) {
      case 0:
        if (trainer->user_controls() == false) {
          ERR(L"An error has been triggered from the "
              "\"user_controls()\" function.", );
...
void Datasets::optimize(WhileCond const &while_cond, bool const save_trainer,
  ...
  do {
    ...
    if (keyboard.trigger_key(0x51)) {
      INFO(
          L"A signal for stopping the training has been triggered from "
          "the user input.");
    ...
    if (report) {
      ...
      if (keyboard.trigger_key(0x4D)) {
        if (this->User_Controls__Optimization(trainer, trained) == false) {
          ERR(L"An error has been triggered from the "
              "\"User_Controls__Optimization(ptr, ptr)\" function.", );
        }
      }
#elif COMPILE_LINUX
    ...
    if (report) {
      ...
      INFO(L"");
      INFO(
          L"[TRAINER]: Train on %zu example(s) from the training "
          "set.",
          this->get_dataset(ENV::TRAIN)->DatasetV1::get_n_data());
    ...
    if (report) {
      ...
      INFO(
          L"[TRAINER]: Validate on %zu example(s) from the validation "
          "set.",
          this->get_dataset(ENV::VALID)->DatasetV1::get_n_data());
    ...
    switch (while_cond.type) {
      ...
      case WHILE_MODE::ITERATION:
        ...
        break;
      default:
        ERR(L"While condition type (%d | %ls) is not managed in "
            "the switch.",
...
void Datasets::Optimization__Testing(bool const report, TIME_POINT &time_str,
  ...
  if (report) {
    INFO(
        L"[TRAINER]: Evaluate %zu example(s) from the testing "
        "set.",
        this->get_dataset(ENV::TESTG)->DatasetV1::get_n_data());
    ...
    if (this->_reference == false) {
      switch (this->_type_storage_data) {
        ...
        case ENUM_TYPE_DATASET_MANAGER_STORAGE::
          ...
          break;
        default:
          ERR(L"DatasetV1 storage type (%d | %ls) is not managed in "
              "the switch.",
    ...
    switch (this->_type_storage_data) {
      case ENUM_TYPE_DATASET_MANAGER_STORAGE::TYPE_STORAGE_TRAINING:
        if (this->Initialize_Dataset_CUDA(ENV::TRAIN) == false) {
          ERR(L"An error has been triggered from the "
              "\"Initialize_Dataset_CUDA(%u)\" function.",
              ENV::TRAIN);
      ...
      case ENUM_TYPE_DATASET_MANAGER_STORAGE::
        ...
        break;
      default:
        ERR(L"DatasetV1 manager type (%d | %ls) is not managed in "
            "the switch.",
            this->_type_storage_data,
            ENUM_TYPE_DATASET_MANAGER_STORAGE_NAMES[this->_type_storage_data]
                .c_str());
...
bool Datasets::Reallocate_Internal_Storage(void) {
  ...
  switch (this->_type_storage_data) {
    case ENUM_TYPE_DATASET_MANAGER_STORAGE::TYPE_STORAGE_TRAINING:
      if ((train_set = this->Allocate__Dataset(tmp_type_dataset_process,
                                               ENV::TRAIN)) == nullptr) {
        ERR(L"An error has been triggered from the "
            "\"Allocate__Dataset(%u, %u)\" function.",
    ...
    case ENUM_TYPE_DATASET_MANAGER_STORAGE::
      ...
      break;
    default:
      ERR(L"DatasetV1 storage type (%d | %ls) is not managed in the "
          "switch.",
          this->_type_storage_data,
          ENUM_TYPE_DATASET_MANAGER_STORAGE_NAMES[this->_type_storage_data]
              .c_str());
  ...
  if (this->Initialize_Dataset(ENV::TRAIN, tmp_type_dataset_process,
    ...
    ERR(L"An error has been triggered from the "
        "\"Initialize_Dataset(%u, %u, ptr)\" function.",
        ENV::TRAIN,
...
bool Datasets::Prepare_Storage(DatasetV1 *const ptr_TrainingSet_received) {
  ...
  if (this->_ptr_array_ptr_Dataset == nullptr) {
    ERR(L"Can not allocate %zu bytes.", sizeof(DatasetV1 *));
...
bool Datasets::Prepare_Storage(size_t const number_examples_training_received,
  ...
  if (number_examples_training_received + number_examples_testing_received !=
    ...
    ERR(L"The number of example(s) from the training set can not "
        "be equal to zero.", );

    return false;
  } else if (number_examples_testing_received == 0_UZ) {
    ERR(L"The number of example(s) from the testing set can not "
        "be equal to zero.", );
  ...
  if (this->_ptr_array_ptr_Dataset == nullptr) {
    ERR(L"Can not allocate %zu bytes.", 2_UZ * sizeof(DatasetV1 *));
...
bool Datasets::Prepare_Storage(size_t const number_examples_training_received,
  ...
  if (number_examples_training_received + number_examples_validation_received +
    ...
    ERR(L"The number of example(s) from the validation set can "
  ...
  if (this->_ptr_array_ptr_Dataset == nullptr) {
    ERR(L"Can not allocate %zu bytes.", 3_UZ * sizeof(DatasetV1 *));
...
bool Datasets::Initialize_Dataset_CUDA(ENV::TYPE const env_type) {
  ...
  if (this->_ptr_CUDA_Dataset_Manager->Set__Type_Gradient_Descent(
    ...
    ERR(L"An error has been triggered from the "
        L"\"CUDA->Set__Type_Gradient_Descent(%u, %u)\" function.",
      ...
      switch (dataset->Get__Type_Dataset_Process()) {
        ...
        case DATASET::MINIBATCH: {
          ...
          if (this->_ptr_CUDA_Dataset_Manager
            ...
            ERR(L"An error has been triggered from the "
                "\"Initialize_Mini_Batch_Stochastic_Gradient_Descent(%ls, %zu, "
                "%zu)\" function.",
                tmp_ptr_Dataset_Mini_Batch->Get__Use__Shuffle() ? "true"
                                                                : "false",
        ...
        case DATASET::CROSS_VAL: {
          ...
          if (this->_ptr_CUDA_Dataset_Manager->Initialize__Cross_Validation(
              ...
              false) {
            ERR(L"An error has been triggered from the "
                "\"Initialize__Cross_Validation(%ls, %zu, %zu)\" function.",
                tmp_ptr_Dataset_Cross_Validation->Get__Use__Shuffle() ? " true"
                                                                      : "false",
                tmp_ptr_Dataset_Cross_Validation->get_n_batch(),
                tmp_ptr_Dataset_Cross_Validation->Get__Number_Sub_Batch());
    ...
    case ENV::TRAIN:
      switch (type_dataset_process_received) {
        case DATASET::BATCH:  // Batch.
          if ((dataset = new DatasetV1) == nullptr) {
            ERR(L"Can not allocate %zu bytes.", sizeof(DatasetV1));
        ...
        case DATASET::MINIBATCH:  // Mini-batch stochastic.
          if ((dataset = new MiniBatch) == nullptr) {
            ERR(L"Can not allocate %zu bytes.", sizeof(MiniBatch));

            return nullptr;
          }
          break;
        case DATASET::CROSS_VAL:  // Cross-validation
          if ((dataset = new CrossVal) == nullptr) {
            ERR(L"Can not allocate %zu bytes.", sizeof(CrossVal));
        ...
        case DATASET::CROSS_VAL_OPT:  // Cross-validation,
                                      // random
                                      // search
          if ((dataset = new CrossValOpt) == nullptr) {
            ERR(L"Can not allocate %zu bytes.", sizeof(CrossValOpt));
      ...
      switch (type_dataset_process_received) {
        ...
        case DATASET::MINIBATCH: {
          ...
          if (ptr_Dataset_Parameters_received == nullptr ||
            ...
            tmp_number_desired_data_per_batch = parse_discrete<size_t>(
          ...
          if (ptr_Dataset_Parameters_received == nullptr ||
            ...
            tmp_number_maximum_batch =
                parse_discrete<size_t>(0_UZ, n_data, L"Maximum sub-sample: ");
        ...
        case DATASET::CROSS_VAL_OPT: {
          ...
          if (ptr_Dataset_Parameters_received == nullptr ||
            ...
            tmp_number_k_folds =
                parse_discrete<size_t>(2_UZ, n_data, L"K-fold: ");
            // |END| K-fold. |END|
          } else {
            tmp_number_k_folds =
                static_cast<size_t>(ptr_Dataset_Parameters_received->value_1);
          ...
          if (tmp_ptr_Dataset_Cross_Validation->Initialize__Fold(
                  ...
                  tmp_number_k_sub_folds) == false) {
            ERR(L"An error has been triggered from the "
                "\"Initialize__Fold(%ls, %zu, %zu)\" function.",
                tmp_use_shuffle ? "true" : "false", tmp_number_k_folds,
                tmp_number_k_sub_folds);
          ...
          if (type_dataset_process_received == DATASET::CROSS_VAL_OPT) {
            ...
            if (ptr_Dataset_Parameters_received == nullptr ||
              ...
              INFO(L"");
              INFO(
                  L"Number hyperparameter optimization "
                  "iteration(s):");
              INFO(L"Range[1, 8].");
              INFO(L"default=10.");
              tmp_number_hyper_optimization_iterations =
                  parse_discrete<size_t>(0_UZ, L"Iteration(s): ");
            } else {
              tmp_number_hyper_optimization_iterations =
            ...
            if (tmp_ptr_Dataset_Cross_Validation_Hyperparameter_Optimization
              ...
              ERR(L"An error has been triggered from the "
                  "\"Set__Number_Hyperparameter_Optimization_Iterations(%zu)\" "
                  "function.",
                  tmp_number_hyper_optimization_iterations);
            ...
            if (ptr_Dataset_Parameters_received == nullptr ||
              ...
              INFO(L"default=25.");
              tmp_number_hyper_optimization_iterations_delay =
                  parse_discrete<size_t>(0_UZ, L"Iteration(s) delay: ");
            } else {
              tmp_number_hyper_optimization_iterations_delay =
...
bool Datasets::Preparing_Dataset_Manager(
  ...
  if (ptr_Dataset_Manager_Parameters_received == nullptr ||
    ...
    tmp_type_storage_choose = parse_discrete<int>(0, 2, L"Choose: ");
  } else {
    tmp_type_storage_choose = static_cast<unsigned int>(
  ...
  if (ptr_Dataset_Manager_Parameters_received == nullptr ||
    ...
    tmp_type_training_choose = parse_discrete<int>(0, 3, L"Choose: ");
  } else {
    tmp_type_training_choose = static_cast<unsigned int>(
  ...
  switch (static_cast<enum ENUM_TYPE_DATASET_MANAGER_STORAGE>(
    ...
    case ENUM_TYPE_DATASET_MANAGER_STORAGE::TYPE_STORAGE_TRAINING:
      if ((train_set = this->Allocate__Dataset(
               static_cast<DATASET::TYPE>(tmp_type_training_choose + 1u),
               ENV::TRAIN)) == nullptr) {
        ERR(L"An error has been triggered from the "
            "\"Allocate__Dataset(%u, %u)\" function.",
            static_cast<DATASET::TYPE>(tmp_type_training_choose + 1u),
    ...
    case ENUM_TYPE_DATASET_MANAGER_STORAGE::TYPE_STORAGE_TRAINING_TESTING:
      ...
      if (this->Prepare_Storage(tmp_percent_training_size,
                                ...
                                tmp_ptr_TestingSet) == false) {
        ERR(L"An error has been triggered from the "
            "\"Prepare_Storage(%f, %f, ptr, ptr)\" function.",
    ...
    case ENUM_TYPE_DATASET_MANAGER_STORAGE::
      ...
      if (this->Prepare_Storage(
              ...
              tmp_ptr_TestingSet) == false) {
        ERR(L"An error has been triggered from the "
            "\"Prepare_Storage(%f, %f, %f, ptr, ptr, ptr)\" function.",
            tmp_percent_training_size, tmp_percent_validation_size,
            tmp_percent_testing_size);
...
double Datasets::train(Model *const model) {
  ...
  if (dataset == nullptr) {
    ERR(L"An error has been triggered from the "
        "\"get_dataset(%ls)\" function. Pointer return is a nullptr.",
...
double Datasets::Optimize(Model *const model) {
  if (this->Get__Hyperparameter_Optimization() != HYPEROPT::NONE &&
    ...
    if (this->HyperOpt::Optimize(this, model) == false) {
      ERR(L"An error has been triggered from the \"Optimize(ptr, "
          "ptr)\" function.", );
...
double Datasets::Type_Testing(ENV::TYPE const env_type, Model *const model) {
  ...
  if (dataset == nullptr) {
    ERR(L"An error has been triggered from the "
        "\"get_dataset(%ls)\" function. Pointer return is a "
        "nullptr.",
        ENV_NAME[env_type].c_str());
  ...
  switch (this->_type_storage_data) {
    ...
    case ENUM_TYPE_DATASET_MANAGER_STORAGE::TYPE_STORAGE_TRAINING_TESTING:
      switch (env_type) {
        ...
        default:
          ERR(L"DatasetV1 type (%d | %ls) is not managed in the "
              "switch.",
